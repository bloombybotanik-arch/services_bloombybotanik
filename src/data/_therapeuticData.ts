...
export const plantsDatabase: PlantData[] = [
    ...
    recette_pas_a_pas: {
      ...
      translations: {
        en: {
          ...
          ingredients: {
            phase_A: ["50g Turmeric powder (or thin slices)", "350ml Distilled Water", "150ml Vegetable Glycerin"],
            phase_B: ["15g Turmeric powder", "10g crushed Black Pepper", "250ml Organic Alcohol 96°"]
          },
          preparation: [
            "1. Weigh the ingredients precisely using a precision scale (0.1g).",
            "2. If using turmeric slices, mix them briefly to obtain a coarse powder (this increases the contact surface).",
            "3. Crush the black pepper berries in a mortar just before extraction to release piperine."
          ],
          phase_A_instructions: [
            "1. Pour 350ml of water and 150ml of glycerin into the clean BloomLab tank.",
            "2. Add the 50g of turmeric.",
            "3. Close the tank hermetically.",
            "4. Turn on the machine, select manual mode 'OIL' (or 'BUTTER').",
            "5. Set TEMPERATURE to 70°C and TIME to 2h00.",
            "6. Press START. Let the cycle finish."
          ],
          transition: [
            "1. At the end of the beep, turn off the machine.",
            "2. Let rest for 15 to 20 minutes. The temperature should drop naturally below 45°C.",
            "3. MANDATORY SENSORY TEST: Place your hand flat on the outer wall of the tank. It should be 'warm to the touch' (about 40°C), and not burning.",
            "4. ⚠️ SAFETY: Only add alcohol when this test is validated."
          ],
          phase_B_instructions: [
            "1. Open the tank. Carefully pour the 250ml of alcohol.",
            "2. Add the mixture of 15g of turmeric and 10g of crushed pepper.",
            "3. Close hermetically.",
            "4. Select manual mode 'OIL' again.",
            "5. Set TEMPERATURE to 50°C and TIME to 3h00.",
            "6. Press START."
          ],
          filtration_et_finition: [
            "1. At the end of the cycle, let rest for 10 min for particles to settle.",
            "2. Place a cheesecloth over a large glass bowl.",
            "3. Pour the contents of the tank slowly.",
            "4. Gather the edges of the cheesecloth and press the grounds firmly with your hands (wear gloves, it stains) to extract every drop.",
            "5. Transfer the filtered elixir into amber glass bottles. Store away from light."
          ]
        },
        de: {
          batch_standard: "BloomLab-Ziel: 750ml Lösungsmittel + 75g Pflanzen (Geschätzte Endausbeute: ~600-650ml)",
          ingredients: {
            phase_A: ["50g Kurkumapulver (oder dünne Scheiben)", "350ml destilliertes Wasser", "150ml pflanzliches Glycerin"],
            phase_B: ["15g Kurkumapulver", "10g zerstoßener schwarzer Pfeffer", "250ml Bio-Alkohol 96°"]
          },
          preparation: [
            "1. Die Zutaten mit einer Feinwaage (0,1g) genau abwiegen.",
            "2. Bei Verwendung von Kurkumascheiben diese kurz mixen, um ein grobes Pulver zu erhalten (vergrößert die Kontaktfläche).",
            "3. Die schwarzen Pfefferkörner kurz vor der Extraktion in einem Mörser zerstoßen, um Piperin freizusetzen."
          ],
          phase_A_instructions: [
            "1. 350ml Wasser und 150ml Glycerin in den sauberen BloomLab-Behälter füllen.",
            "2. Die 50g Kurkuma hinzufügen.",
            "3. Den Behälter hermetisch schließen.",
            "4. Maschine einschalten, manuellen Modus 'OIL' (oder 'BUTTER') wählen.",
            "5. TEMPERATUR auf 70°C und ZEIT auf 2h00 einstellen.",
            "6. START drücken. Zyklus beenden lassen."
          ],
          transition: [
            "1. Am Ende des Pieptons die Maschine ausschalten.",
            "2. 15 bis 20 Minuten ruhen lassen. Die Temperatur sollte natürlich unter 45°C sinken.",
            "3. OBLIGATORISCHER SENSORTTEST: Legen Sie Ihre Hand flach auf die Außenwand des Behälters. Sie sollte sich 'handwarm' anfühlen (ca. 40°C) und nicht heiß sein.",
            "4. ⚠️ SICHERHEIT: Alkohol erst hinzufügen, wenn dieser Test bestanden ist."
          ],
          phase_B_instructions: [
            "1. Behälter öffnen. Vorsichtig die 250ml Alkohol einfüllen.",
            "2. Die Mischung aus 15g Kurkuma und 10g zerstoßenem Pfeffer hinzufügen.",
            "3. Hermetisch schließen.",
            "4. Erneut manuellen Modus 'OIL' wählen.",
            "5. TEMPERATUR auf 50°C und ZEIT auf 3h00 einstellen.",
            "6. START drücken."
          ],
          filtration_et_finition: [
            "1. Am Ende des Zyklus 10 Min. ruhen lassen, damit sich die Partikel absetzen können.",
            "2. Ein Seihtuch über eine große Glasschüssel legen.",
            "3. Den Inhalt des Behälters langsam eingießen.",
            "4. Die Ränder des Seihtuchs fassen und den Trester mit den Händen fest auspressen (Handschuhe tragen, färbt ab), um jeden Tropfen zu gewinnen.",
            "5. Das filtrierte Elixier in Braunglasflaschen umfüllen. Vor Licht geschützt aufbewahren."
          ]
        }
      }
    },
    ...
    recette_pas_a_pas: {
      ...
      translations: {
        en: {
          batch_standard: "BloomLab Target: 750ml solvent + 75g plants (Estimated final yield: ~600-650ml)",
          ingredients: {
            phase_A: ["50g Boswellia resin tears", "350ml Distilled Water", "150ml Vegetable Glycerin"],
            phase_B: ["25g crushed Boswellia resin", "250ml Organic Alcohol 96°"]
          },
          preparation: [
            "1. Place the resin tears in the freezer 30 minutes before weighing (prevents sticking to the scale).",
            "2. Crush the cold tears in a mortar or with the back of a heavy spoon to obtain rice-sized pieces."
          ],
          phase_A_instructions: [
            "1. Pour 350ml of water and 150ml of glycerin into the tank.",
            "2. Add the 50g of crushed resin.",
            "3. Close, manual mode 'OIL', TEMP 60°C, TIME 2h00. START."
          ],
          transition: [
            "1. Turn off the machine at the end of the cycle.",
            "2. Let rest for 20 minutes. The temperature should drop naturally below 45°C.",
            "3. MANDATORY SENSORY TEST: Place your hand flat on the outer wall of the tank. It should be 'warm to the touch' (about 40°C), and not burning.",
            "4. ⚠️ SAFETY: Only add alcohol when this test is validated."
          ],
          phase_B_instructions: [
            "1. Open, pour the 250ml of alcohol, add the remaining 25g of resin.",
            "2. Close, manual mode 'OIL', TEMP 45°C, TIME 4h00. START. (Long time is necessary to solubilize the resin)."
          ],
          filtration_et_finition: [
            "1. Filtering resin can be sticky. Use a fine cheesecloth and rinse the grounds with a tiny bit of pure alcohol to recover the last actives.",
            "2. Press firmly. Put in an amber bottle."
          ]
        },
        de: {
          batch_standard: "BloomLab-Ziel: 750ml Lösungsmittel + 75g Pflanzen (Geschätzte Endausbeute: ~600-650ml)",
          ingredients: {
            phase_A: ["50g Weihrauchharztränen", "350ml destilliertes Wasser", "150ml pflanzliches Glycerin"],
            phase_B: ["25g zerkleinertes Weihrauchharz", "250ml Bio-Alkohol 96°"]
          },
          preparation: [
            "1. Die Harztränen 30 Minuten vor dem Abwiegen in den Gefrierschrank legen (verhindert das Kleben an der Waage).",
            "2. Die kalten Tränen in einem Mörser oder mit dem Rücken eines schweren Löffels zerkleinern, um reiskorngroße Stücke zu erhalten."
          ],
          phase_A_instructions: [
            "1. 350ml Wasser und 150ml Glycerin in den Behälter füllen.",
            "2. Die 50g zerkleinertes Harz hinzufügen.",
            "3. Schließen, manueller Modus 'OIL', TEMP 60°C, ZEIT 2h00. START."
          ],
          transition: [
            "1. Maschine am Ende des Zyklus ausschalten.",
            "2. 20 Minuten ruhen lassen. Die Temperatur sollte natürlich unter 45°C sinken.",
            "3. OBLIGATORISCHER SENSORTTEST: Legen Sie Ihre Hand flach auf die Außenwand des Behälters. Sie sollte sich 'handwarm' anfühlen (ca. 40°C) und nicht heiß sein.",
            "4. ⚠️ SICHERHEIT: Alkohol erst hinzufügen, wenn dieser Test bestanden ist."
          ],
          phase_B_instructions: [
            "1. Öffnen, die 250ml Alkohol einfüllen, die restlichen 25g Harz hinzufügen.",
            "2. Schließen, manueller Modus 'OIL', TEMP 45°C, ZEIT 4h00. START. (Lange Zeit ist erforderlich, um das Harz zu lösen)."
          ],
          filtration_et_finition: [
            "1. Das Filtern von Harz kann klebrig sein. Verwenden Sie ein feines Seihtuch und spülen Sie den Trester mit ein wenig reinem Alkohol ab, um die letzten Wirkstoffe zu gewinnen.",
            "2. Fest auspressen. In eine Braunglasflasche füllen."
          ]
        }
      }
    },
  ...
  },
  {
    ...
    recette_pas_a_pas: {
      ...
      translations: {
        en: {
          batch_standard: "BloomLab Target: 750ml solvent + 3g Saffron (Estimated final yield: ~700ml). Note: Saffron is dosed by effect, not standard plant weight.",
          ingredients: {
            phase_A: ["2g Saffron Stigmas", "350ml Distilled Water", "150ml Vegetable Glycerin"],
            phase_B: ["1g Saffron Stigmas", "250ml Organic Alcohol 96°"]
          },
          preparation: [
            "1. Weigh the saffron with a precision scale (0.01g if possible). 3g in total is enough for a powerful therapeutic effect on this volume.",
            "2. Do not grind the threads, leave them whole to avoid premature oxidation."
          ],
          phase_A_instructions: [
            "1. Pour water and glycerin into the tank. Add 2g of saffron.",
            "2. Close, manual mode 'OIL', TEMP 50°C, TIME 1h30. START."
          ],
          transition: [
            "1. Turn off. Let rest for 20 minutes.",
            "2. MANDATORY SENSORY TEST: Place your hand on the outer wall of the tank. It should be 'warm to the touch' (about 40°C), and not burning.",
            "3. ⚠️ SAFETY: Only add alcohol when this test is validated."
          ],
          phase_B_instructions: [
            "1. Add alcohol and the remaining 1g of saffron.",
            "2. Close, manual mode 'OIL', TEMP 40°C, TIME 2h00. START."
          ],
          filtration_et_finition: [
            "1. Filter VERY finely with the provided filter bag, while the preparation is still warm. Press the grounds firmly.",
            "2. The final liquid will have a deep ruby red color. Must be stored in violet (Miron) or amber glass, in the refrigerator after opening."
          ]
        },
        de: {
          batch_standard: "BloomLab-Ziel: 750ml Lösungsmittel + 3g Safran (Geschätzte Endausbeute: ~700ml). Hinweis: Safran wird nach Wirkung dosiert, nicht nach Standard-Pflanzengewicht.",
          ingredients: {
            phase_A: ["2g Safrannarben", "350ml destilliertes Wasser", "150ml pflanzliches Glycerin"],
            phase_B: ["1g Safrannarben", "250ml Bio-Alkohol 96°"]
          },
          preparation: [
            "1. Safran mit einer Präzisionswaage (möglichst 0,01g) abwiegen. 3g insgesamt reichen für eine starke therapeutische Wirkung bei diesem Volumen aus.",
            "2. Die Fäden nicht zermahlen, sondern im Ganzen lassen, um eine vorzeitige Oxidation zu vermeiden."
          ],
          phase_A_instructions: [
            "1. Wasser und Glycerin in den Behälter füllen. 2g Safran hinzufügen.",
            "2. Schließen, manueller Modus 'OIL', TEMP 50°C, ZEIT 1h30. START."
          ],
          transition: [
            "1. Ausschalten. 20 Minuten ruhen lassen.",
            "2. OBLIGATORISCHER SENSORTTEST: Legen Sie Ihre Hand auf die Außenwand des Behälters. Sie sollte sich 'handwarm' anfühlen (ca. 40°C) und nicht heiß sein.",
            "3. ⚠️ SICHERHEIT: Alkohol erst hinzufügen, wenn dieser Test bestanden ist."
          ],
          phase_B_instructions: [
            "1. Alkohol und das restliche 1g Safran hinzufügen.",
            "2. Schließen, manueller Modus 'OIL', TEMP 40°C, ZEIT 2h00. START."
          ],
          filtration_et_finition: [
            "1. SEHR fein mit dem mitgelieferten Filterbeutel filtern, solange die Zubereitung noch warm ist. Den Trester fest auspressen.",
            "2. Die fertige Flüssigkeit hat eine tief rubinrote Farbe. Unbedingt in Violettglas (Miron) oder Braunglas im Kühlschrank nach dem Öffnen aufbewahren."
          ]
        }
      }
    },
    ...
    recette_pas_a_pas: {
      ...
      translations: {
        en: {
          batch_standard: "BloomLab Target: 750ml solvent + 75g plants (Estimated final yield: ~600-650ml)",
          ingredients: {
            phase_A: ["50g Dried Nettle Leaves", "350ml Distilled Water", "150ml Vegetable Glycerin"],
            phase_B: ["25g Dried Nettle Roots (crushed)", "250ml Organic Alcohol 96°"]
          },
          preparation: [
            "1. Nettle roots are very hard. Crush them vigorously in a mortar or chop them finely.",
            "2. Leaves can be used as is, or slightly crumpled by hand."
          ],
          phase_A_instructions: [
            "1. Pour water and glycerin. Add the 50g of leaves.",
            "2. Close, manual mode 'OIL', TEMP 75°C, TIME 2h00. START."
          ],
          transition: [
            "1. Turn off. Let rest for 20 minutes.",
            "2. MANDATORY SENSORY TEST: Place your hand on the outer wall of the tank. It should be 'warm to the touch' (about 40°C), and not burning.",
          ...
          phase_B_instructions: [
            "1. Add alcohol and the 25g of roots.",
            "2. Close, manual mode 'OIL', TEMP 50°C, TIME 3h00. START."
          ],
          filtration_et_finition: [
            "1. Filter VERY finely with the provided filter bag while the preparation is still warm. Press the grounds firmly. Press the root grounds well, this is where phytosterols are concentrated.",
            "2. The liquid will have a beautiful dark green-brown color. Put in a bottle."
          ]
        },
        de: {
          batch_standard: "BloomLab-Ziel: 750ml Lösungsmittel + 75g Pflanzen (Geschätzte Endausbeute: ~600-650ml)",
          ingredients: {
            phase_A: ["50g getrocknete Brennnesselblätter", "350ml destilliertes Wasser", "150ml pflanzliches Glycerin"],
            phase_B: ["25g getrocknete Brennnesselwurzeln (zerstoßen)", "250ml Bio-Alkohol 96°"]
          },
          preparation: [
            "1. Brennnesselwurzeln sind sehr hart. Zerstoßen Sie sie kräftig im Mörser oder hacken Sie sie fein.",
            "2. Die Blätter können so verwendet oder leicht von Hand zerrieben werden."
          ],
          phase_A_instructions: [
            "1. Wasser und Glycerin einfüllen. Die 50g Blätter hinzufügen.",
            "2. Schließen, manueller Modus 'OIL', TEMP 75°C, ZEIT 2h00. START."
          ],
          transition: [
            "1. Ausschalten. 20 Minuten ruhen lassen.",
            "2. OBLIGATORISCHER SENSORTTEST: Legen Sie Ihre Hand auf die Außenwand des Behälters. Sie sollte sich 'handwarm' anfühlen (ca. 40°C) und nicht heiß sein.",
          ...
          phase_B_instructions: [
            "1. Alkohol und die 25g Wurzeln hinzufügen.",
            "2. Schließen, manueller Modus 'OIL', TEMP 50°C, ZEIT 3h00. START."
          ],
          filtration_et_finition: [
            "1. Mit dem mitgelieferten Filterbeutel SEHR fein filtern, solange die Zubereitung noch warm ist. Den Trester fest auspressen. Den Wurzel-Trester gut auspressen, da sich dort die Phytosterine konzentrieren.",
            "2. Die Flüssigkeit wird eine schöne dunkelgrün-braune Farbe haben. In eine Flasche füllen."
          ]
        }
      }
    },
  ...
  },
  {
    ...
    recette_pas_a_pas: {
      ...
      translations: {
        en: {
          batch_standard: "BloomLab Target: 750ml solvent + 75g plants (Estimated final yield: ~600-650ml)",
          ingredients: {
            phase_A: ["50g Dried Horsetail stems", "350ml Distilled Water", "150ml Vegetable Glycerin"],
            phase_B: ["25g Dried Horsetail stems", "250ml Organic Alcohol 70°"]
          },
          preparation: [
            "1. Horsetail is very abrasive and sharp. Wear gloves if handling with bare hands.",
            "2. Break stems into 1 to 2 cm long pieces to optimize extraction without creating dust."
          ],
          phase_A_instructions: [
            "1. Pour water and glycerin. Add 50g horsetail.",
            "2. Close, manual mode 'OIL', TEMP 80°C, TIME 2h30. START. (Higher temperature is necessary for silica)."
          ],
          transition: [
            "1. Turn off. Let rest for 25 minutes. Horsetail retains a lot of heat, be patient.",
            "2. MANDATORY SENSORY TEST: Place your hand on the outer wall of the tank. It should be 'warm to the touch' (about 40°C), and not burning.",
            "3. ⚠️ SAFETY: Only add alcohol when this test is validated."
          ],
          phase_B_instructions: [
            "1. Add alcohol and the remaining 25g of horsetail.",
            "2. Close, manual mode 'OIL', TEMP 50°C, TIME 2h00. START."
          ],
          filtration_et_finition: [
            "1. Filter VERY finely with the provided filter bag while the preparation is still warm. Press the grounds firmly. Horsetail leaves many siliceous residues (a fine powder at the bottom).",
            "2. Let the filtrate settle for 2h in the refrigerator, then rack off the clear liquid to avoid deposits in the final bottle."
          ]
        },
        de: {
          batch_standard: "BloomLab-Ziel: 750ml Lösungsmittel + 75g Pflanzen (Geschätzte Endausbeute: ~600-650ml)",
          ingredients: {
            phase_A: ["50g getrocknete Schachtelhalmstängel", "350ml destilliertes Wasser", "150ml pflanzliches Glycerin"],
            phase_B: ["25g getrocknete Schachtelhalmstängel", "250ml Bio-Alkohol 70°"]
          },
          preparation: [
            "1. Schachtelhalm ist sehr abrasiv und scharfkantig. Tragen Sie Handschuhe, wenn Sie ihn mit bloßen Händen anfassen.",
            "2. Die Stängel in 1 bis 2 cm lange Stücke brechen, um die Extraktion zu optimieren, ohne Staub zu erzeugen."
          ],
          phase_A_instructions: [
            "1. Wasser und Glycerin einfüllen. 50g Schachtelhalm hinzufügen.",
            "2. Schließen, manueller Modus 'OIL', TEMP 80°C, ZEIT 2h30. START. (Höhere Temperatur ist für Silizium erforderlich)."
          ],
          transition: [
            "1. Ausschalten. 25 Minuten ruhen lassen. Schachtelhalm speichert viel Hitze, haben Sie Geduld.",
            "2. OBLIGATORISCHER SENSORTTEST: Legen Sie Ihre Hand auf die Außenwand des Behälters. Sie sollte sich 'handwarm' anfühlen (ca. 40°C) und nicht heiß sein.",
            "3. ⚠️ SICHERHEIT: Alkohol erst hinzufügen, wenn dieser Test bestanden ist."
          ],
          phase_B_instructions: [
            "1. Alkohol und die restlichen 25g Schachtelhalm hinzufügen.",
            "2. Schließen, manueller Modus 'OIL', TEMP 50°C, ZEIT 2h00. START."
          ],
          filtration_et_finition: [
            "1. Mit dem mitgelieferten Filterbeutel SEHR fein filtern, solange die Zubereitung noch warm ist. Den Trester fest auspressen. Schachtelhalm hinterlässt viele kieselsäurehaltige Rückstände (ein feines Pulver am Boden).",
            "2. Das Filtrat 2 Stunden im Kühlschrank absetzen lassen, dann die klare Flüssigkeit abziehen, um Ablagerungen in der Endflasche zu vermeiden."
          ]
        }
      }
    },
    ...
    translations: {
      en: {
        ...
        famille_bloom: "Repairer (Structure & Connective tissue)",
        preuve_scientifique: "The richest land plant in silica (up to 10%). Silica is essential for collagen synthesis, bone mineralization, and keratin structure.",
        convergence_ancestrale: "Used by the Romans to fuse bone fractures. In Ayurveda, it is known as 'Punarnava' (the one that renews the body).",
        precautions: "Contraindicated in case of kidney or heart failure. Course of 3 weeks max, followed by a one-week break."
      },
      de: {
        nom_commun: "Acker-Schachtelhalm",
        partie_utilisee: "Getrocknete sterile Stängel",
        famille_bloom: "Reparatur (Struktur & Bindegewebe)",
        preuve_scientifique: "Die kieselsäurereichste Landpflanze (bis zu 10%). Kieselsäure ist für die Kollagensynthese, die Knochenmineralisierung und die Keratinstruktur unerlässlich.",
        convergence_ancestrale: "Wurde von den Römern verwendet, um Knochenbrüche zu verschweißen. Im Ayurveda ist sie als 'Punarnava' bekannt (diejenige, die den Körper erneuert).",
        precautions: "Kontraindiziert bei Nieren- oder Herzinsuffizienz. Kur von maximal 3 Wochen, gefolgt von einer einwöchigen Pause."
      }
    }
  },
  {
    ...
    recette_pas_a_pas: {
      ...
      translations: {
        en: {
          batch_standard: "BloomLab Target: 750ml solvent + 75g plants (Estimated final yield: ~600-650ml)",
          ingredients: {
            phase_A: ["50g Dried Ginger Rhizome (slices)", "350ml Distilled Water", "150ml Vegetable Glycerin"],
            phase_B: ["25g Dried Ginger Rhizome (coarse powder)", "250ml Organic Alcohol 96°"]
          },
          preparation: [
            "1. Weigh 50g of slices for Phase A and mix the remaining 25g into coarse powder for Phase B (increases contact surface).",
            "2. If the ginger is very dry, feel free to crush it slightly in a mortar."
          ],
          phase_A_instructions: [
            "1. Pour the 350ml of water and 150ml of glycerin into the tank.",
            "2. Add the 50g of ginger slices.",
            "3. Close, manual mode 'OIL', TEMP 70°C, TIME 2h00. START."
          ],
          transition: [
            "1. At the end of the beep, turn off the machine.",
            "2. Let rest for 15 to 20 minutes. The temperature should drop naturally below 45°C.",
            "3. MANDATORY SENSORY TEST: Place your hand flat on the outer wall of the tank. It should be 'warm to the touch' (about 40°C, like comfortable bath water), and not burning.",
            "4. ⚠️ SAFETY: Only add alcohol when this test is validated to avoid any sudden vaporization or inflammatory risk."
          ],
          phase_B_instructions: [
            "1. Open the tank. Carefully pour the 250ml of alcohol.",
            "2. Add the 25g of ginger powder.",
            "3. Close hermetically.",
            "4. Manual mode 'OIL', TEMP 45°C, TIME 3h00. START."
          ],
          filtration_et_finition: [
            "1. Filter VERY finely with the provided filter bag while the preparation is still warm. Press the grounds firmly.",
            "2. Press the grounds firmly. The liquid will have a golden amber color and a powerful spicy smell. Put in an amber bottle."
          ]
        },
        de: {
          batch_standard: "BloomLab-Ziel: 750ml Lösungsmittel + 75g Pflanzen (Geschätzte Endausbeute: ~600-650ml)",
          ingredients: {
            phase_A: ["50g getrockneter Ingwer-Rhizom (Scheiben)", "350ml destilliertes Wasser", "150ml pflanzliches Glycerin"],
            phase_B: ["25g getrockneter Ingwer-Rhizom (grobes Pulver)", "250ml Bio-Alkohol 96°"]
            },
          preparation: [
            "1. 50g Scheiben für Phase A abwiegen und die restlichen 25g zu grobem Pulver für Phase B mahlen (erhöht die Kontaktfläche).",
            "2. Wenn der Ingwer sehr trocken ist, können Sie ihn leicht im Mörser zerstoßen."
          ],
          phase_A_instructions: [
            "1. Die 350ml Wasser und 150ml Glycerin in den Behälter füllen.",
            "2. Die 50g Ingwer-Scheiben hinzufügen.",
            "3. Schließen, manueller Modus 'OIL', TEMP 70°C, ZEIT 2h00. START."
          ],
          transition: [
            "1. Am Ende des Signaltons die Maschine ausschalten.",
            "2. 15 bis 20 Minuten ruhen lassen. Die Temperatur sollte natürlich unter 45°C sinken.",
            "3. OBLIGATORISCHER SENSORTTEST: Legen Sie Ihre Hand flach auf die Außenwand des Behälters. Sie sollte sich 'handwarm' anfühlen (ca. 40°C, wie angenehmes Badewasser) und nicht heiß sein.",
            "4. ⚠️ SICHERHEIT: Alkohol erst hinzufügen, wenn dieser Test bestanden ist, um plötzliches Verdampfen oder Brandgefahr zu vermeiden."
          ],
          phase_B_instructions: [
            "1. Den Behälter öffnen. Vorsichtig die 250ml Alkohol eingießen.",
            "2. Die 25g Ingwerpulver hinzufügen.",
            "3. Hermetisch verschließen.",
            "4. Manueller Modus 'OIL', TEMP 45°C, ZEIT 3h00. START."
          ],
          filtration_et_finition: [
            "1. Mit dem mitgelieferten Filterbeutel SEHR fein filtern, solange die Zubereitung noch warm ist. Den Trester fest auspressen.",
            "2. Den Trester fest auspressen. Die Flüssigkeit wird eine goldene Bernsteinfarbe und einen starken würzigen Geruch haben. In eine Braunglasflasche füllen."
          ]
        }
      }
    },
    ...
    recette_pas_a_pas: {
      ...
      translations: {
        en: {
          batch_standard: "BloomLab Target: 750ml solvent + 75g plants (Estimated final yield: ~600-650ml)",
          ingredients: {
            phase_A: ["50g Skullcap Root (chips)", "350ml Distilled Water", "150ml Vegetable Glycerin"],
            phase_B: ["25g Skullcap Root (powder)", "250ml Organic Alcohol 96°"]
          },
          preparation: [
            "1. The root is very hard and fibrous. Crush the 50g into small chips.",
            "2. Mix the remaining 25g into fine powder for Phase B."
          ],
          phase_A_instructions: [
            "1. Pour water and glycerin. Add the 50g of chips.",
            "2. Close, manual mode 'OIL', TEMP 75°C, TIME 2h00. START."
          ],
          transition: [
            "1. Turn off. Let rest for 20 minutes.",
          ...
          phase_B_instructions: [
            "1. Add alcohol and the 25g of powder.",
            "2. Close, manual mode 'OIL', TEMP 50°C, TIME 3h00. START."
          ],
          filtration_et_finition: [
            "1. Filter VERY finely with the provided filter bag while the preparation is still warm. Press the grounds firmly. Skullcap root leaves a characteristic yellow deposit (baicalin).",
            "2. Press well. The final liquid is an intense yellow. Put in an amber bottle."
          ]
        },
        de: {
          batch_standard: "BloomLab-Ziel: 750ml Lösungsmittel + 75g Pflanzen (Geschätzte Endausbeute: ~600-650ml)",
          ingredients: {
            phase_A: ["50g Helmkrautwurzel (Stücke)", "350ml destilliertes Wasser", "150ml pflanzliches Glycerin"],
            phase_B: ["25g Helmkrautwurzel (Pulver)", "250ml Bio-Alkohol 96°"]
          },
          preparation: [
            "1. Die Wurzel ist sehr hart und faserig. Die 50g in kleine Späne zerkleinern.",
            "2. Die restlichen 25g zu feinem Pulver für Phase B mahlen."
          ],
          phase_A_instructions: [
            "1. Wasser und Glycerin einfüllen. Die 50g Späne hinzufügen.",
            "2. Schließen, manueller Modus 'OIL', TEMP 75°C, ZEIT 2h00. START."
          ],
          transition: [
            "1. Ausschalten. 20 Minuten ruhen lassen.",
          ...
          phase_B_instructions: [
            "1. Alkohol und die 25g Pulver hinzufügen.",
            "2. Schließen, manueller Modus 'OIL', TEMP 50°C, ZEIT 3h00. START."
          ],
          filtration_et_finition: [
            "1. Mit dem mitgelieferten Filterbeutel SEHR fein filtern, solange die Zubereitung noch warm ist. Den Trester fest auspressen. Die Helmkrautwurzel hinterlässt eine charakteristische gelbe Ablagerung (Baicalin).",
            "2. Gut auspressen. Die endgültige Flüssigkeit ist von intensivem Gelb. In eine Braunglasflasche füllen."
          ]
        }
      }
    },
    ...
    recette_pas_a_pas: {
      ...
      translations: {
        en: {
          batch_standard: "BloomLab Target: 750ml solvent + 75g plants (Estimated final yield: ~600-650ml)",
          ingredients: {
            phase_A: ["50g Rhodiola Rhizome (chips)", "350ml Distilled Water", "150ml Vegetable Glycerin"],
            phase_B: ["25g Rhodiola Rhizome (powder)", "250ml Organic Alcohol 96°"]
          },
          preparation: [
            "1. The rhizome is very dense. Crush the 50g into chips.",
            "2. Mix the remaining 25g into powder."
          ],
          phase_A_instructions: [
            "1. Pour water and glycerin. Add the 50g of chips.",
            "2. Close, manual mode 'OIL', TEMP 75°C, TIME 2h00. START."
          ...
          phase_B_instructions: [
            "1. Add alcohol and the 25g of powder.",
            "2. Close, manual mode 'OIL', TEMP 45°C, TIME 3h00. START."
          ],
          filtration_et_finition: [
            "1. Filter VERY finely with the provided filter bag while the preparation is still warm. Press the grounds firmly. Press the grounds.",
            "2. The elixir will have a brown-red color and a subtle smell of rose and earth. Put in a bottle."
          ]
        },
        de: {
          batch_standard: "BloomLab-Ziel: 750ml Lösungsmittel + 75g Pflanzen (Geschätzte Endausbeute: ~600-650ml)",
          ingredients: {
            phase_A: ["50g Rhodiola-Rhizom (Stücke)", "350ml destilliertes Wasser", "150ml pflanzliches Glycerin"],
            phase_B: ["25g Rhodiola-Rhizom (Pulver)", "250ml Bio-Alkohol 96°"]
          },
          preparation: [
            "1. Das Rhizom ist sehr dicht. Die 50g in Späne zerkleinern.",
            "2. Die restlichen 25g zu Pulver mahlen."
          ],
          phase_A_instructions: [
            "1. Wasser und Glycerin einfüllen. Die 50g Späne hinzufügen.",
            "2. Schließen, manueller Modus 'OIL', TEMP 75°C, ZEIT 2h00. START."
          ...
          phase_B_instructions: [
            "1. Alkohol und die 25g Pulver hinzufügen.",
            "2. Schließen, manueller Modus 'OIL', TEMP 45°C, ZEIT 3h00. START."
          ],
          filtration_et_finition: [
            "1. Mit dem mitgelieferten Filterbeutel SEHR fein filtern, solange die Zubereitung noch warm ist. Den Trester fest auspressen. Den Trester auspressen.",
            "2. Das Elixier wird eine braunrote Farbe und einen subtilen Duft nach Rose und Erde haben. In eine Flasche füllen."
          ]
        }
      }
    },
  ...
  },
  {
    ...
    recette_pas_a_pas: {
      ...
      translations: {
        en: {
          batch_standard: "BloomLab Target: 750ml solvent + 75g plants (Estimated final yield: ~600-650ml)",
          ingredients: {
            phase_A: ["50g Griffonia Seeds (whole or crushed)", "350ml Distilled Water", "150ml Vegetable Glycerin"],
            phase_B: ["25g Griffonia Seeds (powder)", "250ml Organic Alcohol 96°"]
          },
          preparation: [
            "1. The seeds are hard. Crush the 50g in a coffee grinder or mortar.",
            "2. Mix the remaining 25g into fine powder."
          ],
          phase_A_instructions: [
            "1. Pour water and glycerin. Add the 50g of crushed seeds.",
            "2. Close, manual mode 'OIL', TEMP 70°C, TIME 2h00. START."
          ],
          transition: [
            "1. Turn off. Let rest for 20 minutes.",
            "2. MANDATORY SENSORY TEST: Place your hand on the outer wall of the tank. It should be 'warm to the touch' (about 40°C), and not burning.",
          ...
          filtration_et_finition: [
            "1. Filter VERY finely with the provided filter bag while the preparation is still warm. Press the grounds firmly.",
            "2. Put in an amber bottle. Store in the dark."
          ]
        },
        de: {
          batch_standard: "BloomLab-Ziel: 750ml Lösungsmittel + 75g Pflanzen (Geschätzte Endausbeute: ~600-650ml)",
          ingredients: {
            phase_A: ["50g Griffonia-Samen (ganz oder zerstoßen)", "350ml destilliertes Wasser", "150ml pflanzliches Glycerin"],
            phase_B: ["25g Griffonia-Samen (Pulver)", "250ml Bio-Alkohol 96°"]
          },
          preparation: [
            "1. Die Samen sind hart. Zerstoßen Sie die 50g in einer Kaffeemühle oder einem Mörser.",
            "2. Die restlichen 25g zu feinem Pulver mahlen."
          ],
          phase_A_instructions: [
            "1. Wasser und Glycerin einfüllen. Die 50g zerstoßenen Samen hinzufügen.",
            "2. Schließen, manueller Modus 'OIL', TEMP 70°C, ZEIT 2h00. START."
          ],
          transition: [
            "1. Ausschalten. 20 Minuten ruhen lassen.",
            "2. OBLIGATORISCHER SENSORTTEST: Legen Sie Ihre Hand auf die Außenwand des Behälters. Sie sollte sich 'handwarm' anfühlen (ca. 40°C) und nicht heiß sein.",
          ...
          filtration_et_finition: [
            "1. Mit dem mitgelieferten Filterbeutel SEHR fein filtern, solange die Zubereitung noch warm ist. Den Trester fest auspressen.",
            "2. In eine Braunglasflasche füllen. Dunkel lagern."
          ]
        }
      }
    },
    ...
    translations: {
      en: {
        ...
        famille_bloom: "Internal Pharmacy (Neurochemical precursor)",
        preuve_scientifique: "5-HTP crosses the blood-brain barrier and is directly converted into serotonin, then melatonin. Effective on mood, sugar cravings, and falling asleep.",
        convergence_ancestrale: "West African plant traditionally used for wound healing, but also as a psychic tonic.",
        precautions: "Absolute prohibition with antidepressants (SSRI): risk of serotonin syndrome."
      },
      de: {
        nom_commun: "Griffonia (Afrikanische Schwarzbohne)",
        partie_utilisee: "Getrocknete Samen",
        famille_bloom: "Innere Apotheke (Neurochemischer Vorläufer)",
        preuve_scientifique: "5-HTP passiert die Blut-Hirn-Schranke und wird direkt in Serotonin und dann in Melatonin umgewandelt. Wirksam bei Stimmung, Heißhunger auf Süßes und beim Einschlafen.",
        convergence_ancestrale: "Westafrikanische Pflanze, die traditionell zur Wundheilung, aber auch als psychisches Tonikum verwendet wird.",
        precautions: "Absolutes Verbot mit Antidepressiva (SSRI): Risiko eines Serotonin-Syndroms."
      }
    }
  },
  {
    ...
    recette_pas_a_pas: {
        ...
        translations: {
          en: {
            batch_standard: "BloomLab Target: 750ml solvent + 75g plants (Estimated final yield: ~600-650ml)",
            ingredients: {
              phase_A: ["50g Gentian Root (chips)", "350ml Distilled Water", "150ml Vegetable Glycerin"],
              phase_B: ["25g Gentian Root (powder)", "250ml Organic Alcohol 96°"]
            },
            preparation: [
              "Vigorously crush the 50g of root for Phase A.",
              "Mix the remaining 25g into a fine powder for Phase B."
            ],
            phase_A_instructions: [
              "Pour water and glycerin. Add the 50g of chips.",
              "Close, manual mode 'OIL', TEMP 75°C, TIME 2h00. START."
            ],
            transition: [
              "1. Turn off. Let rest for 20 minutes.",
              "2. MANDATORY SENSORY TEST: Place your hand on the outer wall of the tank. It should be 'warm to the touch' (about 40°C), and not burning.",
            ...
            phase_B_instructions: [
              "Add alcohol and the 25g of powder.",
              "Close, manual mode 'OIL', TEMP 50°C, TIME 3h00. START."
            ],
            filtration_et_finition: [
              "Filter through cheesecloth. Firmly press the root grounds.",
              "The liquid will be a deep brown-red, extremely bitter. Put in an amber bottle."
            ]
          },
          de: {
            batch_standard: "BloomLab-Ziel: 750ml Lösungsmittel + 75g Pflanzen (Geschätzte Endausbeute: ~600-650ml)",
            ingredients: {
              phase_A: ["50g Enzianwurzel (Stücke)", "350ml destilliertes Wasser", "150ml pflanzliches Glycerin"],
              phase_B: ["25g Enzianwurzel (Pulver)", "250ml Bio-Alkohol 96°"]
            },
            preparation: [
              "Die 50g Wurzel für Phase A kräftig zerkleinern.",
              "Die restlichen 25g für Phase B zu feinem Pulver mahlen."
            ],
            phase_A_instructions: [
              "Wasser und Glycerin einfüllen. Die 50g Späne hinzufügen.",
              "Schließen, manueller Modus 'OIL', TEMP 75°C, ZEIT 2h00. START."
            ],
            transition: [
              "1. Ausschalten. 20 Minuten ruhen lassen.",
              "2. OBLIGATORISCHER SENSORTTEST: Legen Sie Ihre Hand auf die Außenwand des Behälters. Sie sollte sich 'handwarm' anfühlen (ca. 40°C) und nicht heiß sein.",
            ...
            phase_B_instructions: [
              "Alkohol und die 25g Pulver hinzufügen.",
              "Schließen, manueller Modus 'OIL', TEMP 50°C, ZEIT 3h00. START."
            ],
            filtration_et_finition: [
              "Durch ein Seihtuch filtern. Die Wurzelrückstände fest auspressen.",
              "Die Flüssigkeit wird tief braunrot und extrem bitter sein. In eine Braunglasflasche füllen."
            ]
          }
        }
      },
    ...
    recette_pas_a_pas: {
        ...
        translations: {
          en: {
            batch_standard: "BloomLab Target: 750ml solvent + 75g plants (Estimated final yield: ~600-650ml)",
            ingredients: {
              phase_A: ["50g Black Radish Root (pieces)", "350ml Distilled water", "150ml Vegetable glycerin"],
              phase_B: ["25g Black Radish Root (powder)", "250ml Organic alcohol 96°"]
            },
            preparation: ["Crush the 50g of root for Phase A.", "Mix the remaining 25g into powder for Phase B."],
            phase_A_instructions: ["Pour water and glycerin. Add the 50g of pieces.", "Close, manual mode 'OIL', TEMP 70°C, TIME 2h00. START."],
            transition: ["1. Turn off. Let rest for 20 minutes.", "2. MANDATORY SENSORY TEST: Place your hand on the outer wall of the tank. It should be 'warm to the touch' (about 40°C), and not burning.", "3. ⚠️ SAFETY: Only add alcohol when this test is validated."],
            phase_B_instructions: ["Add alcohol and the 25g of powder.", "Close, manual mode 'OIL', TEMP 45°C, TIME 3h00. START."],
            filtration_et_finition: ["Filter with cheesecloth. The smell will be sulfurous and characteristic.", "Press the grounds. Put in an amber bottle."]
          },
          de: {
            batch_standard: "BloomLab-Ziel: 750ml Lösungsmittel + 75g Pflanzen (Geschätzte Endausbeute: ~600-650ml)",
            ingredients: {
              phase_A: ["50g Schwarzer Rettich Wurzel (Stücke)", "350ml destilliertes Wasser", "150ml pflanzliches Glycerin"],
              phase_B: ["25g Schwarzer Rettich Wurzel (Pulver)", "250ml Bio-Alkohol 96°"]
            },
            preparation: ["Die 50g Wurzel für Phase A zerkleinern.", "Die restlichen 25g für Phase B zu Pulver mahlen."],
            phase_A_instructions: ["Wasser und Glycerin einfüllen. Die 50g Stücke hinzufügen.", "Schließen, manueller Modus 'OIL', TEMP 70°C, ZEIT 2h00. START."],
            transition: ["1. Ausschalten. 20 Minuten ruhen lassen.", "2. OBLIGATORISCHER SENSORTTEST: Legen Sie Ihre Hand auf die Außenwand des Behälters. Sie sollte sich 'handwarm' anfühlen (ca. 40°C) und nicht heiß sein.", "3. ⚠️ SICHERHEIT: Alkohol erst hinzufügen, wenn dieser Test bestanden ist."],
            phase_B_instructions: ["Alkohol und die 25g Pulver hinzufügen.", "Schließen, manueller Modus 'OIL', TEMP 45°C, ZEIT 3h00. START."],
            filtration_et_finition: ["Mit einem Seihtuch filtern. Der Geruch wird schwefelig und charakteristisch sein.", "Den Trester auspressen. In eine Braunglasflasche füllen."]
          }
        }
      },
    socle_synergique: {
    ...
    recette_pas_a_pas: {
        ...
        translations: {
          en: {
            batch_standard: "BloomLab Target: 750ml solvent + 75g plants (Estimated final yield: ~600-650ml)",
            ingredients: {
              phase_A: ["50g Dried Chrysanthellum", "350ml Distilled water", "150ml Vegetable glycerin"],
              phase_B: ["25g Dried Chrysanthellum", "250ml Organic alcohol 96°"]
            },
            preparation: ["The plant is light and bulky. Pack the 50g into the tank.", "Mix the remaining 25g for Phase B."],
            phase_A_instructions: ["Pour water and glycerin. Add the 50g of packed plant.", "Close, manual mode 'OIL', TEMP 70°C, TIME 2h00. START."],
            transition: ["1. Turn off. Let rest for 20 minutes.", "2. MANDATORY SENSORY TEST: Place your hand on the outer wall of the tank. It should be 'warm to the touch' (about 40°C), and not burning.", "3. ⚠️ SAFETY: Only add alcohol when this test is validated."],
            phase_B_instructions: ["Add alcohol and the 25g of mixed plant.", "Close, manual mode 'OIL', TEMP 50°C, TIME 3h00. START."],
            filtration_et_finition: ["Filter with cheesecloth. Press the grounds.", "The liquid will be green-brown. Put in an amber bottle."]
          },
          de: {
            batch_standard: "BloomLab-Ziel: 750ml Lösungsmittel + 75g Pflanzen (Geschätzte Endausbeute: ~600-650ml)",
            ingredients: {
              phase_A: ["50g Getrocknetes Chrysanthellum", "350ml destilliertes Wasser", "150ml pflanzliches Glycerin"],
              phase_B: ["25g Getrocknetes Chrysanthellum", "250ml Bio-Alkohol 96°"]
            },
            preparation: ["Die Pflanze ist leicht und voluminös. Die 50g in den Behälter drücken.", "Die restlichen 25g für Phase B mixen."],
            phase_A_instructions: ["Wasser und Glycerin einfüllen. Die 50g der gepressten Pflanze hinzufügen.", "Schließen, manueller Modus 'OIL', TEMP 70°C, ZEIT 2h00. START."],
            transition: ["1. Ausschalten. 20 Minuten ruhen lassen.", "2. OBLIGATORISCHER SENSORTTEST: Legen Sie Ihre Hand auf die Außenwand des Behälters. Sie sollte sich 'handwarm' anfühlen (ca. 40°C) und nicht heiß sein.", "3. ⚠️ SICHERHEIT: Alkohol erst hinzufügen, wenn dieser Test bestanden ist."],
            phase_B_instructions: ["Alkohol und die 25g der gemixten Pflanze hinzufügen.", "Schließen, manueller Modus 'OIL', TEMP 50°C, ZEIT 3h00. START."],
            filtration_et_finition: ["Mit einem Seihtuch filtern. Den Trester auspressen.", "Die Flüssigkeit wird grün-braun sein. In eine Braunglasflasche füllen."]
          }
        }
      },
    socle_synergique: {
    ...
    recette_pas_a_pas: {
        ...
        translations: {
          en: {
            batch_standard: "BloomLab Target: 750ml solvent + 75g plants (Estimated final yield: ~600-650ml)",
            ingredients: {
              phase_A: ["50g Dried Desmodium", "350ml Distilled water", "150ml Vegetable glycerin"],
              phase_B: ["25g Dried Desmodium", "250ml Organic alcohol 96°"]
            },
            preparation: ["The plant is very light. Pack the 50g firmly into the tank.", "Mix the remaining 25g for Phase B."],
            phase_A_instructions: ["Pour water and glycerin. Add the 50g of packed plant.", "Close, manual mode 'OIL', TEMP 70°C, TIME 2h00. START."],
            transition: ["1. Turn off. Let rest for 20 minutes.", "2. MANDATORY SENSORY TEST: Place your hand on the outer wall of the tank. It should be 'warm to the touch' (about 40°C), and not burning.", "3. ⚠️ SAFETY: Only add alcohol when this test is validated."],
            phase_B_instructions: ["Add alcohol and the 25g of mixed plant.", "Close, manual mode 'OIL', TEMP 50°C, TIME 3h00. START."],
            filtration_et_finition: ["Filter with cheesecloth. Press the grounds.", "The liquid will be dark green. Put in an amber bottle."]
          },
          de: {
            batch_standard: "BloomLab-Ziel: 750ml Lösungsmittel + 75g Pflanzen (Geschätzte Endausbeute: ~600-650ml)",
            ingredients: {
              phase_A: ["50g Getrocknetes Desmodium", "350ml destilliertes Wasser", "150ml pflanzliches Glycerin"],
              phase_B: ["25g Getrocknetes Desmodium", "250ml Bio-Alkohol 96°"]
            },
            preparation: ["Die Pflanze ist sehr leicht. Die 50g fest in den Behälter drücken.", "Die restlichen 25g für Phase B mixen."],
            phase_A_instructions: ["Wasser und Glycerin einfüllen. Die 50g der gepressten Pflanze hinzufügen.", "Schließen, manueller Modus 'OIL', TEMP 70°C, ZEIT 2h00. START."],
            transition: ["1. Ausschalten. 20 Minuten ruhen lassen.", "2. OBLIGATORISCHER SENSORTTEST: Legen Sie Ihre Hand auf die Außenwand des Behälters. Sie sollte sich 'handwarm' anfühlen (ca. 40°C) und nicht heiß sein.", "3. ⚠️ SICHERHEIT: Alkohol erst hinzufügen, wenn dieser Test bestanden ist."],
            phase_B_instructions: ["Alkohol und die 25g der gemixten Pflanze hinzufügen.", "Schließen, manueller Modus 'OIL', TEMP 50°C, ZEIT 3h00. START."],
            filtration_et_finition: ["Mit einem Seihtuch filtern. Den Trester auspressen.", "Die Flüssigkeit wird dunkelgrün sein. In eine Braunglasflasche füllen."]
          }
        }
      },
    socle_synergique: {
    ...
    recette_pas_a_pas: {
        ...
        translations: {
          en: {
            batch_standard: "BloomLab Target: 750ml solvent + 75g plants (Estimated final yield: ~600-650ml)",
            ingredients: {
              phase_A: ["50g Burdock Root (shavings)", "350ml Distilled water", "150ml Vegetable glycerin"],
              phase_B: ["25g Burdock Root (powder)", "250ml Organic alcohol 96°"]
            },
            preparation: ["Crush the 50g of root for Phase A.", "Mix the remaining 25g into powder for Phase B."],
            phase_A_instructions: ["Pour water and glycerin. Add the 50g of shavings.", "Close, manual mode 'OIL', TEMP 75°C, TIME 2h30. START."],
            transition: ["1. Turn off. Let rest for 25 minutes (dense root retains heat).", "2. MANDATORY SENSORY TEST: Place your hand on the outer wall of the tank. It should be 'warm to the touch' (about 40°C), and not burning.", "3. ⚠️ SAFETY: Only add alcohol when this test is validated."],
            phase_B_instructions: ["Add alcohol and the 25g of powder.", "Close, manual mode 'OIL', TEMP 50°C, TIME 3h00. START."],
            filtration_et_finition: ["Filter with cheesecloth. Firmly press the root grounds.", "The liquid will be brown-yellow. Put in an amber bottle."]
          },
          de: {
            batch_standard: "BloomLab-Ziel: 750ml Lösungsmittel + 75g Pflanzen (Geschätzte Endausbeute: ~600-650ml)",
            ingredients: {
              phase_A: ["50g Klettenwurzel (Späne)", "350ml destilliertes Wasser", "150ml pflanzliches Glycerin"],
              phase_B: ["25g Klettenwurzel (Pulver)", "250ml Bio-Alkohol 96°"]
            },
            preparation: ["Die 50g Wurzel für Phase A zerkleinern.", "Die restlichen 25g für Phase B zu Pulver mahlen."],
            phase_A_instructions: ["Wasser und Glycerin einfüllen. Die 50g Späne hinzufügen.", "Schließen, manueller Modus 'OIL', TEMP 75°C, ZEIT 2h30. START."],
            transition: ["1. Ausschalten. 25 Minuten ruhen lassen (die dichte Wurzel speichert die Wärme).", "2. OBLIGATORISCHER SENSORTTEST: Legen Sie Ihre Hand auf die Außenwand des Behälters. Sie sollte sich 'handwarm' anfühlen (ca. 40°C) und nicht heiß sein.", "3. ⚠️ SICHERHEIT: Alkohol erst hinzufügen, wenn dieser Test bestanden ist."],
            phase_B_instructions: ["Alkohol und die 25g Pulver hinzufügen.", "Schließen, manueller Modus 'OIL', TEMP 50°C, ZEIT 3h00. START."],
            filtration_et_finition: ["Mit einem Seihtuch filtern. Den Wurzeltrester fest auspressen.", "Die Flüssigkeit wird braun-gelb sein. In eine Braunglasflasche füllen."]
          }
        }
      },
    socle_synergique: {
    ...
    recette_pas_a_pas: {
        ...
        translations: {
          en: {
            batch_standard: "BloomLab Target: 750ml solvent + 75g plants (Estimated final yield: ~600-650ml)",
            ingredients: {
              phase_A: ["50g Astragalus Root (shavings)", "350ml Distilled water", "150ml Vegetable glycerin"],
              phase_B: ["25g Astragalus Root (powder)", "250ml Organic alcohol 96°"]
            },
            preparation: ["Crush the 50g of root for Phase A.", "Mix the remaining 25g into powder for Phase B."],
            phase_A_instructions: ["Pour water and glycerin. Add the 50g of shavings.", "Close, manual mode 'OIL', TEMP 75°C, TIME 2h30. START."],
            transition: ["1. Turn off. Let rest for 25 minutes.", "2. MANDATORY SENSORY TEST: Place your hand on the outer wall of the tank. It should be 'warm to the touch' (about 40°C), and not burning.", "3. ⚠️ SAFETY: Only add alcohol when this test is validated."],
            phase_B_instructions: ["Add alcohol and the 25g of powder.", "Close, manual mode 'OIL', TEMP 50°C, TIME 3h00. START."],
            filtration_et_finition: ["Filter with cheesecloth. Firmly press the grounds.", "The liquid will be pale yellow. Put in an amber bottle."]
          },
          de: {
            batch_standard: "BloomLab-Ziel: 750ml Lösungsmittel + 75g Pflanzen (Geschätzte Endausbeute: ~600-650ml)",
            ingredients: {
              phase_A: ["50g Astragaluswurzel (Späne)", "350ml destilliertes Wasser", "150ml pflanzliches Glycerin"],
              phase_B: ["25g Astragaluswurzel (Pulver)", "250ml Bio-Alkohol 96°"]
            },
            preparation: ["Die 50g Wurzel für Phase A zerkleinern.", "Die restlichen 25g für Phase B zu Pulver mahlen."],
            phase_A_instructions: ["Wasser und Glycerin einfüllen. Die 50g Späne hinzufügen.", "Schließen, manueller Modus 'OIL', TEMP 75°C, ZEIT 2h30. START."],
            transition: ["1. Ausschalten. 25 Minuten ruhen lassen.", "2. OBLIGATORISCHER SENSORTTEST: Legen Sie Ihre Hand auf die Außenwand des Behälters. Sie sollte sich 'handwarm' anfühlen (ca. 40°C) und nicht heiß sein.", "3. ⚠️ SICHERHEIT: Alkohol erst hinzufügen, wenn dieser Test bestanden ist."],
            phase_B_instructions: ["Alkohol und die 25g Pulver hinzufügen.", "Schließen, manueller Modus 'OIL', TEMP 50°C, ZEIT 3h00. START."],
            filtration_et_finition: ["Mit einem Seihtuch filtern. Den Trester fest auspressen.", "Die Flüssigkeit wird hellgelb sein. In eine Braunglasflasche füllen."]
          }
        }
      },
    socle_synergique: {
    ...
    recette_pas_a_pas: {
        ...
        translations: {
          en: {
            batch_standard: "BloomLab Target: 750ml solvent + 75g plants (Estimated final yield: ~600-650ml)",
            ingredients: {
              phase_A: ["50g Eleuthero Root (shavings)", "350ml Distilled water", "150ml Vegetable glycerin"],
              phase_B: ["25g Eleuthero Root (powder)", "250ml Organic alcohol 96°"]
            },
            preparation: ["Crush the 50g of root for Phase A.", "Mix the remaining 25g into powder for Phase B."],
            phase_A_instructions: ["Pour water and glycerin. Add the 50g of shavings.", "Close, manual mode 'OIL', TEMP 75°C, TIME 2h00. START."],
            transition: ["1. Turn off. Let rest for 20 minutes.", "2. MANDATORY SENSORY TEST: Place your hand on the outer wall of the tank. It should be 'warm to the touch' (about 40°C), and not burning.", "3. ⚠️ SAFETY: Only add alcohol when this test is validated."],
            phase_B_instructions: ["Add alcohol and the 25g of powder.", "Close, manual mode 'OIL', TEMP 50°C, TIME 3h00. START."],
            filtration_et_finition: ["Filter with cheesecloth. Press the grounds.", "The liquid will be light brown. Put in an amber bottle."]
          },
          de: {
            batch_standard: "BloomLab-Ziel: 750ml Lösungsmittel + 75g Pflanzen (Geschätzte Endausbeute: ~600-650ml)",
            ingredients: {
              phase_A: ["50g Eleutherococcuswurzel (Späne)", "350ml destilliertes Wasser", "150ml pflanzliches Glycerin"],
              phase_B: ["25g Eleutherococcuswurzel (Pulver)", "250ml Bio-Alkohol 96°"]
            },
            preparation: ["Die 50g Wurzel für Phase A zerkleinern.", "Die restlichen 25g für Phase B zu Pulver mahlen."],
            phase_A_instructions: ["Wasser und Glycerin einfüllen. Die 50g Späne hinzufügen.", "Schließen, manueller Modus 'OIL', TEMP 75°C, ZEIT 2h00. START."],
            transition: ["1. Ausschalten. 20 Minuten ruhen lassen.", "2. OBLIGATORISCHER SENSORTTEST: Legen Sie Ihre Hand auf die Außenwand des Behälters. Sie sollte sich 'handwarm' anfühlen (ca. 40°C) und nicht heiß sein.", "3. ⚠️ SICHERHEIT: Alkohol erst hinzufügen, wenn dieser Test bestanden ist."],
            phase_B_instructions: ["Alkohol und die 25g Pulver hinzufügen.", "Schließen, manueller Modus 'OIL', TEMP 50°C, ZEIT 3h00. START."],
            filtration_et_finition: ["Mit einem Seihtuch filtern. Den Trester auspressen.", "Die Flüssigkeit wird hellbraun sein. In eine Braunglasflasche füllen."]
          }
        }
      },
    socle_synergique: {
    ...
    recette_pas_a_pas: {
        ...
        translations: {
          en: {
            batch_standard: "BloomLab Target: 750ml solvent + 75g plants (Estimated final yield: ~600-650ml)",
            ingredients: {
              phase_A: ["50g Dried Bacopa", "350ml Distilled water", "150ml Vegetable glycerin"],
              phase_B: ["25g Dried Bacopa", "250ml Organic alcohol 96°"]
            },
            preparation: ["The plant is light. Pack the 50g into the tank.", "Mix the remaining 25g for Phase B."],
            phase_A_instructions: ["Pour water and glycerin. Add the 50g of packed plant.", "Close, manual mode 'OIL', TEMP 65°C, TIME 2h00. START."],
            transition: ["1. Turn off. Let rest for 20 minutes.", "2. MANDATORY SENSORY TEST: Place your hand on the outer wall of the tank. It should be 'warm to the touch' (about 40°C), and not burning.", "3. ⚠️ SAFETY: Only add alcohol when this test is validated."],
            phase_B_instructions: ["Add alcohol and the 25g of mixed plant.", "Close, manual mode 'OIL', TEMP 50°C, TIME 3h00. START."],
            filtration_et_finition: ["Filter with cheesecloth. Press the grounds.", "The liquid will be green-brown. Put in an amber bottle."]
          },
          de: {
            batch_standard: "BloomLab-Ziel: 750ml Lösungsmittel + 75g Pflanzen (Geschätzte Endausbeute: ~600-650ml)",
            ingredients: {
              phase_A: ["50g Getrocknetes Bacopa", "350ml destilliertes Wasser", "150ml pflanzliches Glycerin"],
              phase_B: ["25g Getrocknetes Bacopa", "250ml Bio-Alkohol 96°"]
            },
            preparation: ["Die Pflanze ist leicht. Die 50g in den Behälter drücken.", "Die restlichen 25g für Phase B mixen."],
            phase_A_instructions: ["Wasser und Glycerin einfüllen. Die 50g der gepressten Pflanze hinzufügen.", "Schließen, manueller Modus 'OIL', TEMP 65°C, ZEIT 2h00. START."],
            transition: ["1. Ausschalten. 20 Minuten ruhen lassen.", "2. OBLIGATORISCHER SENSORTTEST: Legen Sie Ihre Hand auf die Außenwand des Behälters. Sie sollte sich 'handwarm' anfühlen (ca. 40°C) und nicht heiß sein.", "3. ⚠️ SICHERHEIT: Alkohol erst hinzufügen, wenn dieser Test bestanden ist."],
            phase_B_instructions: ["Alkohol und die 25g der gemixten Pflanze hinzufügen.", "Schließen, manueller Modus 'OIL', TEMP 50°C, ZEIT 3h00. START."],
            filtration_et_finition: ["Mit einem Seihtuch filtern. Den Trester auspressen.", "Die Flüssigkeit wird grün-braun sein. In eine Braunglasflasche füllen."]
          }
    ...
    recette_pas_a_pas: {
        ...
        translations: {
          en: {
            batch_standard: "BloomLab Target: 750ml solvent + 75g plants (Estimated final yield: ~600-650ml)",
            ingredients: {
              phase_A: ["50g Reishi (coarse powder)", "350ml Distilled water", "150ml Vegetable glycerin"],
              phase_B: ["25g Reishi (fine powder)", "250ml Organic alcohol 96°"]
            },
            preparation: ["Use pre-ground Reishi or grind it finely. The texture is very hard.", "Separate into 50g for Phase A and 25g for Phase B."],
            phase_A_instructions: ["Pour water and glycerin. Add the 50g of powder.", "Close, manual mode 'OIL', TEMP 80°C, TIME 3h00. START."],
            transition: ["1. Turn off. Let rest for 30 minutes (mushroom powder retains heat).", "2. MANDATORY SENSORY TEST: Place your hand on the outer wall of the tank. It should be 'warm to the touch' (about 40°C), and not burning.", "3. ⚠️ SAFETY: Only add alcohol when this test is validated."],
            phase_B_instructions: ["Add alcohol and the 25g of fine powder.", "Close, manual mode 'OIL', TEMP 50°C, TIME 3h00. START."],
            filtration_et_finition: ["Filter with double-layered cheesecloth. Press very firmly.", "The liquid will be dark brown and bitter. Put in an amber bottle."]
          },
          de: {
            batch_standard: "BloomLab-Ziel: 750ml Lösungsmittel + 75g Pflanzen (Geschätzte Endausbeute: ~600-650ml)",
            ingredients: {
              phase_A: ["50g Reishi (grobes Pulver)", "350ml destilliertes Wasser", "150ml pflanzliches Glycerin"],
              phase_B: ["25g Reishi (feines Pulver)", "250ml Bio-Alkohol 96°"]
            },
            preparation: ["Verwenden Sie bereits gemahlenen Reishi oder mahlen Sie ihn fein. Die Textur ist sehr hart.", "In 50g für Phase A und 25g für Phase B aufteilen."],
            phase_A_instructions: ["Wasser und Glycerin einfüllen. Die 50g Pulver hinzufügen.", "Schließen, manueller Modus 'OIL', TEMP 80°C, ZEIT 3h00. START."],
            transition: ["1. Ausschalten. 30 Minuten ruhen lassen (Pilzpulver speichert die Wärme).", "2. OBLIGATORISCHER SENSORTTEST: Legen Sie Ihre Hand auf die Außenwand des Behälters. Sie sollte sich 'handwarm' anfühlen (ca. 40°C) und nicht heiß sein.", "3. ⚠️ SICHERHEIT: Alkohol erst hinzufügen, wenn dieser Test bestanden ist."],
            phase_B_instructions: ["Alkohol und die 25g feines Pulver hinzufügen.", "Schließen, manueller Modus 'OIL', TEMP 50°C, ZEIT 3h00. START."],
            filtration_et_finition: ["Mit einem doppellagigen Seihtuch filtern. Sehr fest auspressen.", "Die Flüssigkeit wird dunkelbraun und bitter sein. In eine Braunglasflasche füllen."]
          }
        }
      },
    socle_synergique: {
    ...
    recette_pas_a_pas: {
        ...
        translations: {
          en: {
            batch_standard: "BloomLab Target: 750ml solvent + 75g plants (Estimated final yield: ~600-650ml)",
            ingredients: {
              phase_A: ["50g Hemp Flowers (lightly crushed)", "350ml Distilled water", "150ml Vegetable glycerin"],
              phase_B: ["25g Hemp Flowers (lightly crushed)", "250ml Jojoba Oil or MCT Coconut Oil"]
            },
            preparation: ["Do not grind the flowers into a fine powder to avoid overly aggressive chlorophyll extraction.", "Coarsely crush by hand."],
            phase_A_instructions: ["Pour water and glycerin. Add the 50g of flowers.", "Close, manual mode 'OIL', TEMP 50°C, TIME 1h00. START."],
            transition: ["1. Turn off. Let rest for 20 minutes.", "2. MANDATORY SENSORY TEST: Place your hand on the outer wall of the tank. It should be 'warm to the touch' (about 40°C), and not burning.", "3. ⚠️ SAFETY: Only add oil when this test is validated."],
            phase_B_instructions: ["Add oil and the remaining 25g of flowers.", "Close, manual mode 'OIL', TEMP 45°C, TIME 4h00. START."],
            filtration_et_finition: ["Filter with cheesecloth. Gently press to avoid clouding the oil.", "The liquid will be an aromatic green/golden oil. Put in an amber bottle."]
          },
          de: {
            batch_standard: "BloomLab-Ziel: 750ml Lösungsmittel + 75g Pflanzen (Geschätzte Endausbeute: ~600-650ml)",
            ingredients: {
              phase_A: ["50g Hanfblüten (leicht zerkleinert)", "350ml destilliertes Wasser", "150ml pflanzliches Glycerin"],
              phase_B: ["25g Hanfblüten (leicht zerkleinert)", "250ml Jojobaöl oder MCT-Kokosöl"]
            },
            preparation: ["Mahlen Sie die Blüten nicht zu einem feinen Pulver, um eine zu aggressive Chlorophyllextraktion zu vermeiden.", "Grob von Hand zerkleinern."],
            phase_A_instructions: ["Wasser und Glycerin einfüllen. Die 50g Blüten hinzufügen.", "Schließen, manueller Modus 'OIL', TEMP 50°C, ZEIT 1h00. START."],
            transition: ["1. Ausschalten. 20 Minuten ruhen lassen.", "2. OBLIGATORISCHER SENSORTTEST: Legen Sie Ihre Hand auf die Außenwand des Behälters. Sie sollte sich 'handwarm' anfühlen (ca. 40°C) und nicht heiß sein.", "3. ⚠️ SICHERHEIT: Öl erst hinzufügen, wenn dieser Test bestanden ist."],
            phase_B_instructions: ["Öl und die restlichen 25g Blüten hinzufügen.", "Schließen, manueller Modus 'OIL', TEMP 45°C, ZEIT 4h00. START."],
            filtration_et_finition: ["Mit einem Seihtuch filtern. Vorsichtig auspressen, um das Öl nicht zu trüben.", "Die Flüssigkeit wird ein aromatisches grün/goldenes Öl sein. In eine Braunglasflasche füllen."]
          }
        }
      },
    socle_synergique: {
    ...
    recette_pas_a_pas: {
        ...
        translations: {
          en: {
            batch_standard: "BloomLab Target: 750ml solvent + 75g plants (Estimated final yield: ~600-650ml)",
            ingredients: {
              phase_A: ["50g Ginkgo Leaves", "350ml Distilled water", "150ml Vegetable glycerin"],
              phase_B: ["25g Ginkgo Leaves", "250ml Organic alcohol 96°"]
            },
            preparation: ["The leaves are relatively light. Pack the 50g into the tank.", "Mix the remaining 25g for Phase B."],
            phase_A_instructions: ["Pour water and glycerin. Add the 50g of packed leaves.", "Close, manual mode 'OIL', TEMP 70°C, TIME 2h00. START."],
            transition: ["1. Turn off. Let rest for 20 minutes.", "2. MANDATORY SENSORY TEST: Place your hand on the outer wall of the tank. It should be 'warm to the touch' (about 40°C), and not burning.", "3. ⚠️ SAFETY: Only add alcohol when this test is validated."],
            phase_B_instructions: ["Add alcohol and the 25g of mixed leaves.", "Close, manual mode 'OIL', TEMP 50°C, TIME 3h00. START."],
            filtration_et_finition: ["Filter with cheesecloth. Press the grounds.", "The liquid will be yellow-green. Put in an amber bottle."]
          },
          de: {
            batch_standard: "BloomLab-Ziel: 750ml Lösungsmittel + 75g Pflanzen (Geschätzte Endausbeute: ~600-650ml)",
            ingredients: {
              phase_A: ["50g Ginkgoblätter", "350ml destilliertes Wasser", "150ml pflanzliches Glycerin"],
              phase_B: ["25g Ginkgoblätter", "250ml Bio-Alkohol 96°"]
            },
            preparation: ["Die Blätter sind relativ leicht. Die 50g in den Behälter drücken.", "Die restlichen 25g für Phase B mixen."],
            phase_A_instructions: ["Wasser und Glycerin einfüllen. Die 50g der gepressten Blätter hinzufügen.", "Schließen, manueller Modus 'OIL', TEMP 70°C, ZEIT 2h00. START."],
            transition: ["1. Ausschalten. 20 Minuten ruhen lassen.", "2. OBLIGATORISCHER SENSORTTEST: Legen Sie Ihre Hand auf die Außenwand des Behälters. Sie sollte sich 'handwarm' anfühlen (ca. 40°C) und nicht heiß sein.", "3. ⚠️ SICHERHEIT: Alkohol erst hinzufügen, wenn dieser Test bestanden ist."],
            phase_B_instructions: ["Alkohol und die 25g der gemixten Blätter hinzufügen.", "Schließen, manueller Modus 'OIL', TEMP 50°C, ZEIT 3h00. START."],
            filtration_et_finition: ["Mit einem Seihtuch filtern. Den Trester auspressen.", "Die Flüssigkeit wird gelb-grün sein. In eine Braunglasflasche füllen."]
          }
        }
      },
    socle_synergique: {
    ...
    recette_pas_a_pas: {
        ...
        translations: {
          en: {
            batch_standard: "BloomLab Target: 750ml solvent + 75g plants (Estimated final yield: ~600-650ml)",
            ingredients: {
              phase_A: ["50g Fenugreek Seeds (lightly crushed)", "350ml Distilled water", "150ml Vegetable glycerin"],
              phase_B: ["25g Fenugreek Seeds (powder)", "250ml Organic alcohol 96°"]
            },
            preparation: ["Lightly crush the 50g of seeds for Phase A (avoid fine powder to prevent gelling the water).", "Mix the remaining 25g into powder for Phase B."],
            phase_A_instructions: ["Pour water and glycerin. Add the 50g of crushed seeds.", "Close, manual mode 'OIL', TEMP 65°C, TIME 2h00. START."],
            transition: ["1. Turn off. Let rest for 20 minutes.", "2. MANDATORY SENSORY TEST: Place your hand on the outer wall of the tank. It should be 'warm to the touch' (about 40°C), and not burning.", "3. ⚠️ SAFETY: Only add alcohol when this test is validated."],
            phase_B_instructions: ["Add alcohol and the 25g of powder.", "Close, manual mode 'OIL', TEMP 50°C, TIME 3h00. START."],
            filtration_et_finition: ["Filter with cheesecloth. The mixture will be slightly viscous (mucilages). Press firmly.", "Put in an amber bottle."]
          },
          de: {
            batch_standard: "BloomLab-Ziel: 750ml Lösungsmittel + 75g Pflanzen (Geschätzte Endausbeute: ~600-650ml)",
            ingredients: {
              phase_A: ["50g Bockshornkleesamen (leicht zerkleinert)", "350ml destilliertes Wasser", "150ml pflanzliches Glycerin"],
              phase_B: ["25g Bockshornkleesamen (Pulver)", "250ml Bio-Alkohol 96°"]
            },
            preparation: ["Die 50g Samen für Phase A leicht zerkleinern (feines Pulver vermeiden, um das Wasser nicht zu gelieren).", "Die restlichen 25g für Phase B zu Pulver mahlen."],
            phase_A_instructions: ["Wasser und Glycerin einfüllen. Die 50g zerkleinerten Samen hinzufügen.", "Schließen, manueller Modus 'OIL', TEMP 65°C, ZEIT 2h00. START."],
            transition: ["1. Ausschalten. 20 Minuten ruhen lassen.", "2. OBLIGATORISCHER SENSORTTEST: Legen Sie Ihre Hand auf die Außenwand des Behälters. Sie sollte sich 'handwarm' anfühlen (ca. 40°C) und nicht heiß sein.", "3. ⚠️ SICHERHEIT: Alkohol erst hinzufügen, wenn dieser Test bestanden ist."],
            phase_B_instructions: ["Alkohol und die 25g Pulver hinzufügen.", "Schließen, manueller Modus 'OIL', TEMP 50°C, ZEIT 3h00. START."],
            filtration_et_finition: ["Mit einem Seihtuch filtern. Die Mischung wird leicht viskos (Schleimstoffe) sein. Fest auspressen.", "In eine Braunglasflasche füllen."]
          }
        }
      },
    socle_synergique: {
    ...
    recette_pas_a_pas: {
        ...
        translations: {
          en: {
            batch_standard: "BloomLab Target: 750ml solvent + 75g plants (Estimated final yield: ~600-650ml)",
            ingredients: {
              phase_A: ["50g Plantain Leaves", "350ml Distilled water", "150ml Vegetable glycerin"],
              phase_B: ["25g Plantain Leaves", "250ml Organic alcohol 70°"]
            },
            preparation: ["The leaves are bulky. Pack the 50g into the tank.", "Mix the remaining 25g for Phase B."],
            phase_A_instructions: ["Pour water and glycerin. Add the 50g of packed leaves.", "Close, manual mode 'OIL', TEMP 60°C, TIME 1h30. START."],
            transition: ["1. Turn off. Let rest for 20 minutes.", "2. MANDATORY SENSORY TEST: Place your hand on the outer wall of the tank. It should be 'warm to the touch' (about 40°C), and not burning.", "3. ⚠️ SAFETY: Only add alcohol when this test is validated."],
            phase_B_instructions: ["Add alcohol and the 25g of mixed leaves.", "Close, manual mode 'OIL', TEMP 45°C, TIME 2h00. START."],
            filtration_et_finition: ["Filter with cheesecloth. Gently press to avoid clouding the extract with too many particles.", "Put in an amber bottle."]
          },
          de: {
            batch_standard: "BloomLab-Ziel: 750ml Lösungsmittel + 75g Pflanzen (Geschätzte Endausbeute: ~600-650ml)",
            ingredients: {
              phase_A: ["50g Wegerichblätter", "350ml destilliertes Wasser", "150ml pflanzliches Glycerin"],
              phase_B: ["25g Wegerichblätter", "250ml Bio-Alkohol 70°"]
            },
            preparation: ["Die Blätter sind voluminös. Die 50g in den Behälter drücken.", "Die restlichen 25g für Phase B mixen."],
            phase_A_instructions: ["Wasser und Glycerin einfüllen. Die 50g der gepressten Blätter hinzufügen.", "Schließen, manueller Modus 'OIL', TEMP 60°C, ZEIT 1h30. START."],
            transition: ["1. Ausschalten. 20 Minuten ruhen lassen.", "2. OBLIGATORISCHER SENSORTTEST: Legen Sie Ihre Hand auf die Außenwand des Behälters. Sie sollte sich 'handwarm' anfühlen (ca. 40°C) und nicht heiß sein.", "3. ⚠️ SICHERHEIT: Alkohol erst hinzufügen, wenn dieser Test bestanden ist."],
            phase_B_instructions: ["Alkohol und die 25g der gemixten Blätter hinzufügen.", "Schließen, manueller Modus 'OIL', TEMP 45°C, ZEIT 2h00. START."],
            filtration_et_finition: ["Mit einem Seihtuch filtern. Vorsichtig auspressen, um den Extrakt nicht mit zu vielen Partikeln zu trüben.", "In eine Braunglasflasche füllen."]
          }
        }
      },
    socle_synergique: {
  ...
  },
  {
    ...
    "recette_pas_a_pas": {
      ...
      "translations": {
        "en": {
          "batch_standard": "750ml solvent + 150g garlic cloves",
          "ingredients": {
            "phase_A": ["100g fresh garlic cloves (crushed)", "350ml Distilled Water", "150ml Vegetable Glycerin"],
            "phase_B": ["50g garlic cloves (sliced)", "250ml Organic Alcohol 96°"]
          },
          "preparation": [
            "1. Crush the 100g of garlic for Phase A and let rest for 15 minutes in the open air (crucial for alliinase activation).",
            "2. Finely slice the 50g of garlic for Phase B."
          ],
          "phase_A_instructions": [
            "1. Pour water and glycerin into the tank.",
            "2. Add the crushed garlic.",
            "3. TEMP: 35°C, TIME: 4h00. START."
          ],
          "transition": ["Check that the temperature has dropped below 35°C."],
          "phase_B_instructions": [
            "1. Add alcohol and sliced garlic.",
            "2. TEMP: 45°C, TIME: 2h00. START."
          ],
          "filtration_et_finition": ["Filtration through a fine cheesecloth. Put in an amber bottle. Recommended cold storage."]
        },
        "de": {
          "batch_standard": "750ml Lösungsmittel + 150g Knoblauchzehen",
          "ingredients": {
            "phase_A": ["100g frische Knoblauchzehen (zerdrückt)", "350ml destilliertes Wasser", "150ml pflanzliches Glycerin"],
            "phase_B": ["50g Knoblauchzehen (in Scheiben)", "250ml Bio-Alkohol 96°"]
          },
          "preparation": [
            "1. Die 100g Knoblauch für Phase A zerdrücken und 15min an der Luft ruhen lassen (entscheidend für die Alliinase-Aktivierung).",
            "2. Die 50g Knoblauch für Phase B fein in Scheiben schneiden."
          ],
          "phase_A_instructions": [
            "1. Wasser und Glycerin in den Behälter füllen.",
            "2. Den zerdrückten Knoblauch hinzufügen.",
            "3. TEMP: 35°C, ZEIT: 4h00. START."
          ],
          "transition": ["Sicherstellen, dass die Temperatur unter 35°C gesunken ist."],
          "phase_B_instructions": [
            "1. Alkohol und in Scheiben geschnittenen Knoblauch hinzufügen.",
            "2. TEMP: 45°C, ZEIT: 2h00. START."
          ],
          "filtration_et_finition": ["Filtration durch ein feines Seihtuch. In eine Braunglasflasche füllen. Kühle Lagerung empfohlen."]
        }
      }
    },
  ...
  },
  {
    ...
    actifs_cles: [
      { nom: "Principes amers (Lactones)", polarite: "Hydrosoluble", translations: { en: { nom: "Bitter principles (Lactones)", polarite: "Water-soluble" }, de: { nom: "Bitterstoffe (Laktone)", polarite: "Wasserlöslich" } } },
      { nom: "Flavonoïdes", polarite: "Hydrosoluble", translations: { en: { nom: "Flavonoids", polarite: "Water-soluble" }, de: { nom: "Flavonoide", polarite: "Wasserlöslich" } } },
      { nom: "Potassium", polarite: "Hydrosoluble", translations: { en: { nom: "Potassium", polarite: "Water-soluble" }, de: { nom: "Kalium", polarite: "Wasserlöslich" } } }
    ],
    ...
    pourquoi_bloomlab: {
      ...
      phase_A: { temp: "60°C", temps: "1h30", solvant: "Eau purifiée", cible: "Minéraux et principes amers", translations: { en: { cible: "Minerals and bitter principles" }, de: { cible: "Mineralien und Bitterstoffe" } } },
      phase_B: { temp: "45°C", temps: "1h00", solvant: "Eau / Glycérine", cible: "Stabilisation des flavonoïdes", translations: { en: { cible: "Flavonoid stabilization" }, de: { cible: "Flavonoid-Stabilisierung" } } },
      resultat: "Un extrait dépuratif doux et reminéralisant.",
      translations: {
        en: {
          probleme_traditionnel: "Classic boiling water infusion can be too aggressive for sensitive actives. Controlled extraction at 60°C preserves the mineral/bitter ratio.",
          resultat: "A gentle depurative and remineralizing extract."
        },
        de: {
          probleme_traditionnel: "Klassische Aufgüsse mit kochendem Wasser können für empfindliche Wirkstoffe zu aggressiv sein. Die kontrollierte Extraktion bei 60°C bewahrt das Mineral-/Bitterstoffverhältnis.",
          resultat: "Ein sanftes reinigendes und remineralisierendes Extrakt."
        }
      }
    },
    recette_pas_a_pas: {
      ...
      translations: {
        en: {
          batch_standard: "750ml solvent + 50g plant",
          ingredients: {
            phase_A: ["35g Dandelion leaves/roots", "500ml Filtered water"],
            phase_B: ["15g Dandelion", "250ml Water/Glycerin mixture"]
          },
          preparation: ["Mix crushed leaves and roots."],
          phase_A_instructions: ["Extract at 60°C for 90 min."],
          transition: ["Filter through cheesecloth."],
          phase_B_instructions: ["Add solvent B and extract at 45°C for 60 min."],
          filtration_et_finition: ["Mix the two phases and put in a bottle."]
        },
        de: {
          batch_standard: "750ml Lösungsmittel + 50g Pflanze",
          ingredients: {
            phase_A: ["35g Löwenzahnblätter/-wurzeln", "500ml gefiltertes Wasser"],
            phase_B: ["15g Löwenzahn", "250ml Wasser-Glycerin-Mischung"]
          },
          preparation: ["Zerkleinerte Blätter und Wurzeln mischen."],
          phase_A_instructions: ["Bei 60°C für 90 Min. extrahieren."],
          transition: ["Durch ein Seihtuch filtern."],
          phase_B_instructions: ["Lösungsmittel B hinzufügen und bei 45°C für 60 Min. extrahieren."],
          filtration_et_finition: ["Die beiden Phasen mischen und in eine Flasche füllen."]
        }
      }
    },
    ...
    translations: {
      en: {
        nom_commun: "Dandelion",
        famille_bloom: "Mediator (Detox & Digestion)",
        preuve_scientifique: "Stimulation of diuresis (increased urine volume) without potassium loss. Choleretic and cholagogue effect facilitating fat digestion."
      },
      de: {
        nom_commun: "Löwenzahn",
        famille_bloom: "Mediator (Entgiftung & Verdauung)",
        preuve_scientifique: "Anregung der Diurese (Erhöhung des Urinvolumens) ohne Kaliumverlust. Choleretische und cholagoge Wirkung zur Erleichterung der Fettverdauung."
      }
    }
  },
  {
    ...
    actifs_cles: [
      { nom: "Anthocyanes", polarite: "Hydrosoluble", translations: { en: { nom: "Anthocyanins", polarite: "Water-soluble" }, de: { nom: "Anthocyane", polarite: "Wasserlöslich" } } },
      { nom: "Flavonoïdes (Quercétine)", polarite: "Hydrosoluble", translations: { en: { nom: "Flavonoids (Quercetin)", polarite: "Water-soluble" }, de: { nom: "Flavonoide (Quercetin)", polarite: "Wasserlöslich" } } },
      { nom: "Vitamine C", polarite: "Hydrosoluble", translations: { en: { nom: "Vitamin C", polarite: "Water-soluble" }, de: { nom: "Vitamin C", polarite: "Wasserlöslich" } } }
    ],
    ...
    pourquoi_bloomlab: {
      ...
      phase_A: { temp: "55°C", temps: "2h00", solvant: "Eau distillée", cible: "Anthocyanes et Vitamine C", translations: { en: { cible: "Anthocyanins and Vitamin C" }, de: { cible: "Anthocyane und Vitamin C" } } },
      phase_B: { temp: "40°C", temps: "1h00", solvant: "Glycérine", cible: "Stabilisation", translations: { en: { cible: "Stabilization" }, de: { cible: "Stabilisierung" } } },
      resultat: "Un élixir protecteur et revitalisant.",
      translations: {
        en: {
          probleme_traditionnel: "Anthocyanins are destroyed by excessive heat. Gentle extraction at 55°C is essential to preserve color and activity.",
          resultat: "A protective and revitalizing elixir."
        },
        de: {
          probleme_traditionnel: "Anthocyane werden durch übermäßige Hitze zerstört. Eine sanfte Extraktion bei 55°C ist unerlässlich, um Farbe und Aktivität zu bewahren.",
          resultat: "Ein schützendes und revitalisierendes Elixier."
        }
      }
    },
    recette_pas_a_pas: {
      ...
      translations: {
        en: {
          batch_standard: "750ml + 60g leaves/berries",
          ingredients: {
            phase_A: ["40g Blackcurrant", "500ml Water"],
            phase_B: ["20g Blackcurrant", "250ml Glycerin"]
          },
          preparation: ["Use dried berries and crushed leaves."],
          phase_A_instructions: ["Extract at 55°C for 120 min."],
          transition: ["Cool down quickly."],
          phase_B_instructions: ["Add glycerin and maintain at 40°C for 60 min."],
          filtration_et_finition: ["Press the grounds firmly to extract all the colored juice."]
        },
        de: {
          batch_standard: "750ml + 60g Blätter/Beeren",
          ingredients: {
            phase_A: ["40g Johannisbeere", "500ml Wasser"],
            phase_B: ["20g Johannisbeere", "250ml Glycerin"]
          },
          preparation: ["Getrocknete Beeren und zerkleinerte Blätter verwenden."],
          phase_A_instructions: ["Bei 55°C für 120 Min. extrahieren."],
          transition: ["Schnell abkühlen."],
          phase_B_instructions: ["Glycerin hinzufügen und bei 40°C für 60 Min. halten."],
          filtration_et_finition: ["Den Trester fest auspressen, um den gesamten farbigen Saft zu extrahieren."]
        }
      }
    },
    ...
    translations: {
      en: {
        nom_commun: "Blackcurrant",
        famille_bloom: "Mediator (Anti-inflammatory & Vitality)",
        preuve_scientifique: "Natural 'cortisone-like' effect by gently stimulating the adrenal glands. Powerful systemic antioxidant and anti-inflammatory."
      },
      de: {
        nom_commun: "Schwarze Johannisbeere",
        famille_bloom: "Mediator (Entzündungshemmend & Vitalität)",
        preuve_scientifique: "Natürlicher 'Cortison-ähnlicher' Effekt durch sanfte Stimulierung der Nebennieren. Starkes systemisches Antioxidans und Entzündungshemmer."
      }
    }
  },
  {
    ...
    actifs_cles: [
      { nom: "Acide Rosmarinique", polarite: "Hydrosoluble", translations: { en: { nom: "Rosmarinic Acid", polarite: "Water-soluble" }, de: { nom: "Rosmarinsäure", polarite: "Wasserlöslich" } } },
      { nom: "Huiles essentielles (Citral)", polarite: "Volatile", translations: { en: { nom: "Essential oils (Citral)", polarite: "Volatile" }, de: { nom: "Ätherische Öle (Citral)", polarite: "Flüchtig" } } }
    ],
    ...
    pourquoi_bloomlab: {
      ...
      phase_A: { temp: "45°C", temps: "2h00", solvant: "Eau / Glycérine", cible: "Acide rosmarinique", translations: { en: { cible: "Rosmarinic acid" }, de: { cible: "Rosmarinsäure" } } },
      phase_B: { temp: "35°C", temps: "1h00", solvant: "Eau", cible: "Huiles essentielles", translations: { en: { cible: "Essential oils" }, de: { cible: "Ätherische Öle" } } },
      resultat: "Une eau de mélisse apaisante et parfumée.",
      translations: {
        en: {
          probleme_traditionnel: "Essential oils escape at 40°C. Vacuum or low-temperature extraction is crucial.",
          resultat: "A soothing and fragrant lemon balm water."
        },
        de: {
          probleme_traditionnel: "Ätherische Öle entweichen ab 40°C. Eine Extraktion bei niedriger Temperatur ist entscheidend.",
          resultat: "Ein beruhigendes und duftendes Melissenwasser."
        }
      }
    },
    recette_pas_a_pas: {
      ...
      translations: {
        en: {
          batch_standard: "750ml + 40g leaves",
          ingredients: {
            phase_A: ["30g Lemon Balm", "500ml solvent"],
            phase_B: ["10g Lemon Balm", "250ml Water"]
          },
          preparation: ["Use well-dried leaves to avoid fermentation."],
          phase_A_instructions: ["Extract at 45°C for 2h."],
          transition: ["Keep the lid closed to trap the aromas."],
          phase_B_instructions: ["Finish at 35°C for 1h."],
          filtration_et_finition: ["Immediate bottling."]
        },
        de: {
          batch_standard: "750ml + 40g Blätter",
          ingredients: {
            phase_A: ["30g Melisse", "500ml Lösungsmittel"],
            phase_B: ["10g Melisse", "250ml Wasser"]
          },
          preparation: ["Gut getrocknete Blätter verwenden, um Gärung zu vermeiden."],
          phase_A_instructions: ["Bei 45°C für 2 Std. extrahieren."],
          transition: ["Deckel geschlossen halten, um die Aromen einzufangen."],
          phase_B_instructions: ["Bei 35°C für 1 Std. beenden."],
          filtration_et_finition: ["Sofortige Abfüllung."]
        }
      }
    },
    ...
    translations: {
      en: {
        nom_commun: "Lemon Balm",
        famille_bloom: "Mediator (Soothing & Digestion)",
        preuve_scientifique: "Antispasmodic action on the digestive tract and regulator of the nervous system. Helps with falling asleep and reduces mild anxiety."
      },
      de: {
        nom_commun: "Zitronenmelisse",
        famille_bloom: "Mediator (Beruhigung & Verdauung)",
        preuve_scientifique: "Krampflösende Wirkung auf den Verdauungstrakt und Regulator des Nervensystems. Hilft beim Einschlafen und reduziert leichte Angstgefühle."
      }
    }
  },
  {
    ...
    actifs_cles: [
      { nom: "Flavonoïdes (Vitexine)", polarite: "Hydrosoluble", translations: { en: { nom: "Flavonoids (Vitexin)", polarite: "Water-soluble" }, de: { nom: "Flavonoide (Vitexin)", polarite: "Wasserlöslich" } } },
      { nom: "Alcaloïdes (Harmala)", polarite: "Liposoluble", translations: { en: { nom: "Alkaloids (Harmala)", polarite: "Fat-soluble" }, de: { nom: "Alkaloide (Harmala)", polarite: "Fettlöslich" } } }
    ],
    ...
    pourquoi_bloomlab: {
      ...
      phase_A: { temp: "60°C", temps: "2h00", solvant: "Eau", cible: "Flavonoïdes", translations: { en: { cible: "Flavonoids" }, de: { cible: "Flavonoide" } } },
      phase_B: { temp: "45°C", temps: "2h00", solvant: "Alcool bio 45°", cible: "Alcaloïdes", translations: { en: { cible: "Alkaloids" }, de: { cible: "Alkaloide" } } },
      resultat: "Un extrait complet pour un sommeil réparateur.",
      translations: {
        en: {
          probleme_traditionnel: "The Totum requires both an aqueous phase and a light alcoholic phase to capture alkaloids.",
          resultat: "A complete extract for a restful sleep."
        },
        de: {
          probleme_traditionnel: "Das Totum erfordert sowohl eine wässrige Phase als auch eine leichte alkoholische Phase, um Alkaloide einzufangen.",
          resultat: "Ein vollständiges Extrakt für einen erholsamen Schlaf."
        }
      }
    },
    recette_pas_a_pas: {
      ...
      translations: {
        en: {
          batch_standard: "750ml + 50g plant",
          ingredients: {
            phase_A: ["35g Passionflower", "500ml Water"],
            phase_B: ["15g Passionflower", "250ml Alcohol 45°"]
          },
          preparation: ["Pack the plant into the tank."],
          phase_A_instructions: ["Extract at 60°C."],
          transition: ["Let cool slightly."],
          phase_B_instructions: ["Add alcohol and extract at 45°C."],
          filtration_et_finition: ["Fine filter required."]
        },
        de: {
          batch_standard: "750ml + 50g Pflanze",
          ingredients: {
            phase_A: ["35g Passionsblume", "500ml Wasser"],
            phase_B: ["15g Passionsblume", "250ml Alkohol 45°"]
          },
          preparation: ["Pflanze in den Behälter drücken."],
          phase_A_instructions: ["Bei 60°C extrahieren."],
          transition: ["Leicht abkühlen lassen."],
          phase_B_instructions: ["Alkohol hinzufügen und bei 45°C extrahieren."],
          filtration_et_finition: ["Feiner Filter erforderlich."]
        }
      }
    },
    ...
    translations: {
      en: {
        nom_commun: "Passionflower",
        famille_bloom: "Mediator (Gentle Sedation)",
        preuve_scientifique: "Increased GABA levels in the brain, promoting muscular and nervous relaxation without habituation."
      },
      de: {
        nom_commun: "Passionsblume",
        famille_bloom: "Mediator (Sanfte Beruhigung)",
        preuve_scientifique: "Erhöhte GABA-Spiegel im Gehirn, was die muskuläre und nervöse Entspannung ohne Gewöhnung fördert."
      }
    }
  },
  {
    ...
    actifs_cles: [
      { nom: "Acide valérénique", polarite: "Liposoluble", translations: { en: { nom: "Valerenic acid", polarite: "Fat-soluble" }, de: { nom: "Valerensäure", polarite: "Fettlöslich" } } },
      { nom: "Valépotriates", polarite: "Liposoluble", translations: { en: { nom: "Valepotriates", polarite: "Fat-soluble" }, de: { nom: "Valepotriate", polarite: "Fettlöslich" } } }
    ],
    ...
    pourquoi_bloomlab: {
      ...
      phase_A: { temp: "50°C", temps: "3h00", solvant: "Eau / Alcool 70°", cible: "Acide valérénique", translations: { en: { cible: "Valerenic acid" }, de: { cible: "Valerensäure" } } },
      phase_B: { temp: "40°C", temps: "1h00", solvant: "Alcool", cible: "Stabilisation", translations: { en: { cible: "Stabilization" }, de: { cible: "Stabilisierung" } } },
      resultat: "Une teinture mère puissante et normalisée.",
      translations: {
        en: {
          probleme_traditionnel: "The smell is strong and actives are mainly lipophilic. Extraction must be hermetic.",
          resultat: "A powerful and normalized mother tincture."
        },
        de: {
          probleme_traditionnel: "Der Geruch ist stark und die Wirkstoffe sind hauptsächlich lipophil. Die Extraktion muss hermetisch sein.",
          resultat: "Eine starke und normalisierte Urtinktur."
        }
      }
    },
    recette_pas_a_pas: {
      ...
      translations: {
        en: {
          batch_standard: "750ml + 75g roots",
          ingredients: {
            phase_A: ["50g Valerian", "500ml mixture"],
            phase_B: ["25g Valerian", "250ml Alcohol"]
          },
          preparation: ["Crush hard roots."],
          phase_A_instructions: ["Extract at 50°C for a long time."],
          transition: ["Maintain airtightness."],
          phase_B_instructions: ["Add the rest of the alcohol."],
          filtration_et_finition: ["Filter and bottle quickly."]
        },
        de: {
          batch_standard: "750ml + 75g Wurzeln",
          ingredients: {
            phase_A: ["50g Baldrian", "500ml Mischung"],
            phase_B: ["25g Baldrian", "250ml Alkohol"]
          },
          preparation: ["Harte Wurzeln zerkleinern."],
          phase_A_instructions: ["Lange bei 50°C extrahieren."],
          transition: ["Luftdichtheit wahren."],
          phase_B_instructions: ["Restlichen Alkohol hinzufügen."],
          filtration_et_finition: ["Schnell filtern und abfüllen."]
        }
      }
    },
    ...
    translations: {
      en: {
        nom_commun: "Valerian",
        famille_bloom: "Trigger (Deep Sleep)",
        preuve_scientifique: "Reduces sleep onset time and improves deep sleep quality. Action on GABA receptors."
      },
      de: {
        nom_commun: "Baldrian",
        famille_bloom: "Trigger (Tiefer Schlaf)",
        preuve_scientifique: "Verkürzt die Einschlafzeit und verbessert die Qualität des Tiefschlafs. Wirkung auf GABA-Rezeptoren."
      }
    }
  },
  {
    ...
    terrains_cibles: ["T7_Psycho_émotionnel", "T4_HPA"],
    actifs_cles: [
      { nom: "Alcaloïdes (Pavine)", polarite: "Liposoluble", translations: { en: { nom: "Alkaloids (Pavine)", polarite: "Fat-soluble" }, de: { nom: "Alkaloide (Pavin)", polarite: "Fettlöslich" } } },
      { nom: "Flavonoïdes", polarite: "Hydrosoluble", translations: { en: { nom: "Flavonoids", polarite: "Water-soluble" }, de: { nom: "Flavonoide", polarite: "Wasserlöslich" } } }
    ],
    ...
    pourquoi_bloomlab: {
      ...
      phase_A: { temp: "55°C", temps: "2h00", solvant: "Eau / Glycérine", cible: "Flavonoïdes", translations: { en: { cible: "Flavonoids" }, de: { cible: "Flavonoide" } } },
      phase_B: { temp: "45°C", temps: "2h00", solvant: "Alcool bio 45°", cible: "Alcaloïdes", translations: { en: { cible: "Alkaloids" }, de: { cible: "Alkaloide" } } },
      resultat: "Un extrait relaxant idéal pour la fin de journée.",
      translations: {
        en: {
          probleme_traditionnel: "Alkaloids are sensitive and require moderate temperature extraction not to be denatured.",
          resultat: "An ideal relaxing extract for the end of the day."
        },
        de: {
          probleme_traditionnel: "Alkaloide sind empfindlich und erfordern eine Extraktion bei moderater Temperatur, um nicht denaturiert zu werden.",
          resultat: "Ein ideales entspannendes Extrakt für das Ende des Tages."
        }
      }
    },
    recette_pas_a_pas: {
      ...
      translations: {
        en: {
          batch_standard: "750ml + 50g plant",
          ingredients: {
            phase_A: ["35g Eschscholtzia", "500ml Water/Gly"],
            phase_B: ["15g Eschscholtzia", "250ml Alcohol 45°"]
          },
          preparation: ["Dried crushed plant."],
          phase_A_instructions: ["Extract at 55°C."],
          transition: ["Let rest."],
          phase_B_instructions: ["Add alcohol and finish at 45°C."],
          filtration_et_finition: ["Cheesecloth filter."]
        },
        de: {
          batch_standard: "750ml + 50g Pflanze",
          ingredients: {
            phase_A: ["35g Eschscholtzia", "500ml Wasser/Gly"],
            phase_B: ["15g Eschscholtzia", "250ml Alkohol 45°"]
          },
          preparation: ["Getrocknete zerkleinerte Pflanze."],
          phase_A_instructions: ["Bei 55°C extrahieren."],
          transition: ["Ruhen lassen."],
          phase_B_instructions: ["Alkohol hinzufügen und bei 45°C beenden."],
          filtration_et_finition: ["Seihtuchfilter."]
        }
      }
    },
    ...
    translations: {
      en: {
        nom_commun: "California Poppy",
        famille_bloom: "Mediator (Sleep & Relaxation)",
        preuve_scientifique: "Anxiolytic and mild sedative action without habituation. Helps maintain sleep throughout the night."
      },
      de: {
        nom_commun: "Kalifornischer Mohn",
        famille_bloom: "Mediator (Schlaf & Entspannung)",
        preuve_scientifique: "Anxiolytische und leicht sedierende Wirkung ohne Gewöhnung. Hilft, den Schlaf die ganze Nacht über aufrechtzuerhalten."
      }
    }
  },
  {
    ...
    actifs_cles: [
      { nom: "Acide Rosmarinique", polarite: "Hydrosoluble", translations: { en: { nom: "Rosmarinic acid", polarite: "Water-soluble" }, de: { nom: "Rosmarinsäure", polarite: "Wasserlöslich" } } },
      { nom: "Diterpènes (Carnosol)", polarite: "Liposoluble", translations: { en: { nom: "Diterpenes (Carnosol)", polarite: "Fat-soluble" }, de: { nom: "Diterpene (Carnosol)", polarite: "Fettlöslich" } } },
      { nom: "Huiles essentielles (Cinole)", polarite: "Volatile", translations: { en: { nom: "Essential oils (Cineole)", polarite: "Volatile" }, de: { nom: "Ätherische Öle (Cineol)", polarite: "Flüchtig" } } }
    ],
    ...
    pourquoi_bloomlab: {
      ...
      phase_A: { temp: "65°C", temps: "1h30", solvant: "Eau distillée", cible: "Acide rosmarinique", translations: { en: { cible: "Rosmarinic acid" }, de: { cible: "Rosmarinsäure" } } },
      phase_B: { temp: "45°C", temps: "1h00", solvant: "Eau / Alcool", cible: "Huiles essentielles", translations: { en: { cible: "Essential oils" }, de: { cible: "Ätherische Öle" } } },
      resultat: "Un tonique hépatique et cérébral majeur.",
      translations: {
        en: {
          probleme_traditionnel: "Boiling infusion loses volatile oils. Extraction at 65°C captures protective diterpenes.",
          resultat: "A major hepatic and cerebral tonic."
        },
        de: {
          probleme_traditionnel: "Beim Kochen gehen flüchtige Öle verloren. Die Extraktion bei 65°C fängt schützende Diterpene ein.",
          resultat: "Ein wichtiges Leber- und Gehirntonikum."
        }
      }
    },
    recette_pas_a_pas: {
      ...
      translations: {
        en: {
          batch_standard: "750ml + 40g plant",
          ingredients: {
            phase_A: ["30g Rosemary", "500ml Water"],
            phase_B: ["10g Rosemary", "250ml Water/Alcohol"]
          },
          preparation: ["Whole dry leaves."],
          phase_A_instructions: ["Extract at 65°C."],
          transition: ["Keep closed."],
          phase_B_instructions: ["Finish at 45°C."],
          filtration_et_finition: ["Amber bottle."]
        },
        de: {
          batch_standard: "750ml + 40g Pflanze",
          ingredients: {
            phase_A: ["30g Rosmarin", "500ml Wasser"],
            phase_B: ["10g Rosmarin", "250ml Wasser/Alkohol"]
          },
          preparation: ["Ganze trockene Blätter."],
          phase_A_instructions: ["Bei 65°C extrahieren."],
          transition: ["Geschlossen halten."],
          phase_B_instructions: ["Bei 45°C beenden."],
          filtration_et_finition: ["In eine Braunglasflasche füllen."]
        }
      }
    },
    ...
    translations: {
      en: {
        nom_commun: "Rosemary",
        famille_bloom: "Trigger (Dynamization & Liver)",
        preuve_scientifique: "Powerful antioxidant protecting the liver and stimulating concentration and memory (neuroprotection)."
      },
      de: {
        nom_commun: "Rosmarin",
        famille_bloom: "Trigger (Dynamisierung & Leber)",
        preuve_scientifique: "Starkes Antioxidans, das die Leber schützt und Konzentration sowie Gedächtnis stimuliert (Neuroprotektion)."
      }
    }
  },
  {
    ...
    actifs_cles: [
      { nom: "Linalol", polarite: "Volatile", translations: { en: { nom: "Linalool", polarite: "Volatile" }, de: { nom: "Linalool", polarite: "Flüchtig" } } },
      { nom: "Acétate de linalyle", polarite: "Volatile", translations: { en: { nom: "Linalyl acetate", polarite: "Volatile" }, de: { nom: "Linalylacetat", polarite: "Flüchtig" } } },
      { nom: "Tanins", polarite: "Hydrosoluble", translations: { en: { nom: "Tannins", polarite: "Water-soluble" }, de: { nom: "Gerbstoffe", polarite: "Wasserlöslich" } } }
    ],
    ...
    pourquoi_bloomlab: {
      ...
      phase_A: { temp: "45°C", temps: "1h00", solvant: "Eau / Glycérine", cible: "Tanins et arômes", translations: { en: { cible: "Tannins and aromas" }, de: { cible: "Gerbstoffe und Aromen" } } },
      phase_B: { temp: "35°C", temps: "1h00", solvant: "Eau", cible: "Stabilisation", translations: { en: { cible: "Stabilization" }, de: { cible: "Stabilisierung" } } },
      resultat: "Une eau florale concentrée et apaisante.",
      translations: {
        en: {
          probleme_traditionnel: "Lavender is very fragile. Heat must be minimal not to transform the scent into a 'hay' smell.",
          resultat: "A concentrated and soothing floral water."
        },
        de: {
          probleme_traditionnel: "Lavendel ist sehr zerbrechlich. Die Hitze muss minimal sein, um den Duft nicht in einen 'Heugeruch' zu verwandeln.",
          resultat: "Ein konzentriertes und beruhigendes Blütenwasser."
        }
      }
    },
    recette_pas_a_pas: {
      ...
      translations: {
        en: {
          batch_standard: "750ml + 30g flowers",
          ingredients: {
            phase_A: ["20g Lavender", "500ml solvent"],
            phase_B: ["10g Lavender", "250ml Water"]
          },
          preparation: ["Use true lavender flowers (angustifolia)."],
          phase_A_instructions: ["Extract at 45°C gently."],
          transition: ["Let cool slightly."],
          phase_B_instructions: ["Finish at 35°C."],
          filtration_et_finition: ["Filter delicately."]
        },
        de: {
          batch_standard: "750ml + 30g Blüten",
          ingredients: {
            phase_A: ["20g Lavendel", "500ml Lösungsmittel"],
            phase_B: ["10g Lavendel", "250ml Wasser"]
          },
          preparation: ["Echten Lavendel (Angustifolia) verwenden."],
          phase_A_instructions: ["Sanft bei 45°C extrahieren."],
          transition: ["Leicht abkühlen lassen."],
          phase_B_instructions: ["Bei 35°C beenden."],
          filtration_et_finition: ["Vorsichtig filtern."]
        }
      }
    },
    ...
    translations: {
      en: {
        nom_commun: "Lavender",
        famille_bloom: "Mediator (Soothing & Harmony)",
        preuve_scientifique: "Demonstrated anxiolytic action by inhalation and ingestion. Regulates mood and soothes nervous tension."
      },
      de: {
        nom_commun: "Lavendel",
        famille_bloom: "Mediator (Beruhigung & Harmonie)",
        preuve_scientifique: "Nachgewiesene anxiolytische Wirkung durch Inhalation und Einnahme. Reguliert die Stimmung und beruhigt nervöse Spannungen."
      }
    }
  },
  {
    ...
    "recette_pas_a_pas": {
      ...
      "translations": {
        "en": {
          "batch_standard": "Bloom Target: 750ml solvent + 24.6g leaves (10 sachets)",
          "ingredients": {
            "phase_A": ["24.6g Artichoke leaves (10 sachets)", "750ml Filtered water"],
            "phase_B": ["Optional: Lemon or Glycerin"]
          },
          "preparation": [
            "1. Open the 10 Artichoke sachets.",
            "2. Pour the contents into the BloomLab tank."
          ],
          "phase_A_instructions": [
            "1. Add 750 ml filtered water.",
            "2. Set to 60°C for 90 minutes.",
            "3. Start the cycle."
          ],
          "transition": [
            "1. Filter while hot using a cheesecloth.",
            "2. Cool quickly to stop oxidation."
          ],
          "phase_B_instructions": [
            "1. No complex phase B required for standard infusion.",
            "2. You can add lemon juice once the liquid is lukewarm."
          ],
          "filtration_et_finition": [
            "1. Transfer to a clean glass bottle.",
            "2. Store in the refrigerator (24h-48h)."
          ]
        },
        "de": {
          "batch_standard": "Bloom-Ziel: 750ml Lösungsmittel + 24,6g Blätter (10 Beutel)",
          "ingredients": {
            "phase_A": ["24,6g Artischockenblätter (10 Beutel)", "750ml gefiltertes Wasser"],
            "phase_B": ["Optional: Zitrone oder Glycerin"]
          },
          "preparation": [
            "1. Die 10 Artischockenbeutel öffnen.",
            "2. Den Inhalt in den BloomLab-Behälter geben."
          ],
          "phase_A_instructions": [
            "1. 750 ml gefiltertes Wasser hinzufügen.",
            "2. Auf 60°C für 90 Minuten einstellen.",
            "3. Den Zyklus starten."
          ],
          "transition": [
            "1. Heiß mit einem Seihtuch filtern.",
            "2. Schnell abkühlen, um die Oxidation zu stoppen."
          ],
          "phase_B_instructions": [
            "1. Keine komplexe Phase B für Standardaufguss erforderlich.",
            "2. Sie können Zitronensaft hinzufügen, sobald die Flüssigkeit lauwarm ist."
          ],
          "filtration_et_finition": [
            "1. In eine saubere Glasflasche umfüllen.",
            "2. Im Kühlschrank aufbewahren (24h-48h)."
          ]
        }
      }
    },
