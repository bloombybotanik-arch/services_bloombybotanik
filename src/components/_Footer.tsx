        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-2">
              ...
              >
                <div className="w-14 h-14 md:w-20 md:h-20 flex items-center justify-center flex-shrink-0 overflow-hidden">
                  <img src="/logo_white.png" alt="Logo Bloom by BotaniK" loading="lazy" className="w-full h-full object-contain scale-125 group-hover/footer-logo:scale-110 transition-all" />
                </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-white/60">
              <li><button onClick={() => onNavigate('machine')} className="hover:text-white transition-colors">La machine et niveaux</button></li>
              <li><button onClick={() => onNavigate('cosmetiques')} className="hover:text-white transition-colors">Cosmétique</button></li>
              ...
              <li><button onClick={() => onNavigate('herbier')} className="hover:text-white transition-colors">{t.nav.herbarium}</button></li>
